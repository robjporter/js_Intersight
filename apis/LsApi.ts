 ...
 * no description
 */
export class LsApiRequestFactory extends BaseAPIRequestFactory {
	
    /**
     * Read a 'ls.ServiceProfile' resource.
     * @param moid The unique Moid identifier of a resource instance.
     */
    public async getLsServiceProfileByMoid(moid: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling getLsServiceProfileByMoid.');
        }

		
		// Path Params
    	const localVarPath = '/ls/ServiceProfiles/{Moid}'
     ...
     */
    public async getLsServiceProfileList(filter?: string, orderby?: string, top?: number, skip?: number, select?: string, expand?: string, apply?: string, count?: boolean, inlinecount?: 'allpages' | 'none', at?: string, tags?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		...
		// Path Params
    	const localVarPath = '/ls/ServiceProfiles';
     ...
     */
    public async patchLsServiceProfile(moid: string, lsServiceProfile: LsServiceProfile, ifMatch?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling patchLsServiceProfile.');
        }

		
        // verify required parameter 'lsServiceProfile' is not null or undefined
        if (lsServiceProfile === null || lsServiceProfile === undefined) {
            throw new RequiredError('Required parameter lsServiceProfile was null or undefined when calling patchLsServiceProfile.');
        }
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(lsServiceProfile, "LsServiceProfile", ""),
            contentType
        );
     ...
     * @param ifMatch For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request.
     */
    public async updateLsServiceProfile(moid: string, lsServiceProfile: LsServiceProfile, ifMatch?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling updateLsServiceProfile.');
        }

		
        // verify required parameter 'lsServiceProfile' is not null or undefined
        if (lsServiceProfile === null || lsServiceProfile === undefined) {
            throw new RequiredError('Required parameter lsServiceProfile was null or undefined when calling updateLsServiceProfile.');
        }
...
export class LsApiResponseProcessor {

    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getLsServiceProfileByMoid
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getLsServiceProfileByMoid(response: ResponseContext): Promise<LsServiceProfile > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: LsServiceProfile = ObjectSerializer.deserialize(
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getLsServiceProfileList
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getLsServiceProfileList(response: ResponseContext): Promise<LsServiceProfileResponse > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: LsServiceProfileResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "LsServiceProfileResponse", ""
            ) as LsServiceProfileResponse;
            return body;
        }
        if (isCodeInRange("400", response.httpStatusCode)) {
            const body: Error = ObjectSerializer.deserialize(
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to patchLsServiceProfile
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async patchLsServiceProfile(response: ResponseContext): Promise<LsServiceProfile > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: LsServiceProfile = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to updateLsServiceProfile
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updateLsServiceProfile(response: ResponseContext): Promise<LsServiceProfile > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: LsServiceProfile = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
