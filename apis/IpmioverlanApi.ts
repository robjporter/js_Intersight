 ...
 * no description
 */
export class IpmioverlanApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async createIpmioverlanPolicy(ipmioverlanPolicy: IpmioverlanPolicy, ifMatch?: string, ifNoneMatch?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'ipmioverlanPolicy' is not null or undefined
        if (ipmioverlanPolicy === null || ipmioverlanPolicy === undefined) {
            throw new RequiredError('Required parameter ipmioverlanPolicy was null or undefined when calling createIpmioverlanPolicy.');
        }
		...
		// Path Params
    	const localVarPath = '/ipmioverlan/Policies';
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(ipmioverlanPolicy, "IpmioverlanPolicy", ""),
            contentType
        );
     ...
     */
    public async deleteIpmioverlanPolicy(moid: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling deleteIpmioverlanPolicy.');
        }

		
		// Path Params
    	const localVarPath = '/ipmioverlan/Policies/{Moid}'
     ...
     * @param moid The unique Moid identifier of a resource instance.
     */
    public async getIpmioverlanPolicyByMoid(moid: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling getIpmioverlanPolicyByMoid.');
        }
     ...
     */
    public async getIpmioverlanPolicyList(filter?: string, orderby?: string, top?: number, skip?: number, select?: string, expand?: string, apply?: string, count?: boolean, inlinecount?: 'allpages' | 'none', at?: string, tags?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
     ...
     * @param ifMatch For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request.
     */
    public async patchIpmioverlanPolicy(moid: string, ipmioverlanPolicy: IpmioverlanPolicy, ifMatch?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling patchIpmioverlanPolicy.');
        }

		
        // verify required parameter 'ipmioverlanPolicy' is not null or undefined
        if (ipmioverlanPolicy === null || ipmioverlanPolicy === undefined) {
            throw new RequiredError('Required parameter ipmioverlanPolicy was null or undefined when calling patchIpmioverlanPolicy.');
        }
     ...
     * @param ifMatch For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request.
     */
    public async updateIpmioverlanPolicy(moid: string, ipmioverlanPolicy: IpmioverlanPolicy, ifMatch?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling updateIpmioverlanPolicy.');
        }

		
        // verify required parameter 'ipmioverlanPolicy' is not null or undefined
        if (ipmioverlanPolicy === null || ipmioverlanPolicy === undefined) {
            throw new RequiredError('Required parameter ipmioverlanPolicy was null or undefined when calling updateIpmioverlanPolicy.');
        }
...
export class IpmioverlanApiResponseProcessor {

    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     * @params response Response returned by the server for a request to createIpmioverlanPolicy
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async createIpmioverlanPolicy(response: ResponseContext): Promise<IpmioverlanPolicy > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: IpmioverlanPolicy = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "IpmioverlanPolicy", ""
            ) as IpmioverlanPolicy;
            return body;
        }
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to deleteIpmioverlanPolicy
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async deleteIpmioverlanPolicy(response: ResponseContext): Promise<void > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            return;
        }
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getIpmioverlanPolicyByMoid
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getIpmioverlanPolicyByMoid(response: ResponseContext): Promise<IpmioverlanPolicy > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: IpmioverlanPolicy = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getIpmioverlanPolicyList
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getIpmioverlanPolicyList(response: ResponseContext): Promise<IpmioverlanPolicyResponse > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: IpmioverlanPolicyResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "IpmioverlanPolicyResponse", ""
            ) as IpmioverlanPolicyResponse;
            return body;
        }
        if (isCodeInRange("400", response.httpStatusCode)) {
            const body: Error = ObjectSerializer.deserialize(
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to patchIpmioverlanPolicy
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async patchIpmioverlanPolicy(response: ResponseContext): Promise<IpmioverlanPolicy > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: IpmioverlanPolicy = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to updateIpmioverlanPolicy
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updateIpmioverlanPolicy(response: ResponseContext): Promise<IpmioverlanPolicy > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: IpmioverlanPolicy = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
