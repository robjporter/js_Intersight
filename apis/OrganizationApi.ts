...
export class OrganizationApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async createOrganizationOrganization(organizationOrganization: OrganizationOrganization, ifMatch?: string, ifNoneMatch?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'organizationOrganization' is not null or undefined
        if (organizationOrganization === null || organizationOrganization === undefined) {
            throw new RequiredError('Required parameter organizationOrganization was null or undefined when calling createOrganizationOrganization.');
        }
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(organizationOrganization, "OrganizationOrganization", ""),
            contentType
        );
     ...
     */
    public async deleteOrganizationOrganization(moid: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling deleteOrganizationOrganization.');
        }

		
		// Path Params
    	const localVarPath = '/organization/Organizations/{Moid}'
     ...
     * @param moid The unique Moid identifier of a resource instance.
     */
    public async getOrganizationOrganizationByMoid(moid: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling getOrganizationOrganizationByMoid.');
        }
     ...
     */
    public async getOrganizationOrganizationList(filter?: string, orderby?: string, top?: number, skip?: number, select?: string, expand?: string, apply?: string, count?: boolean, inlinecount?: 'allpages' | 'none', at?: string, tags?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
     ...
     * @param ifMatch For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request.
     */
    public async patchOrganizationOrganization(moid: string, organizationOrganization: OrganizationOrganization, ifMatch?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling patchOrganizationOrganization.');
        }

		
        // verify required parameter 'organizationOrganization' is not null or undefined
        if (organizationOrganization === null || organizationOrganization === undefined) {
            throw new RequiredError('Required parameter organizationOrganization was null or undefined when calling patchOrganizationOrganization.');
        }
     ...
     * @param ifMatch For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request.
     */
    public async updateOrganizationOrganization(moid: string, organizationOrganization: OrganizationOrganization, ifMatch?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling updateOrganizationOrganization.');
        }

		
        // verify required parameter 'organizationOrganization' is not null or undefined
        if (organizationOrganization === null || organizationOrganization === undefined) {
            throw new RequiredError('Required parameter organizationOrganization was null or undefined when calling updateOrganizationOrganization.');
        }
...
export class OrganizationApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to createOrganizationOrganization
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async createOrganizationOrganization(response: ResponseContext): Promise<OrganizationOrganization > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: OrganizationOrganization = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "OrganizationOrganization", ""
            ) as OrganizationOrganization;
            return body;
        }
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to deleteOrganizationOrganization
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async deleteOrganizationOrganization(response: ResponseContext): Promise<void > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            return;
        }
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getOrganizationOrganizationByMoid
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getOrganizationOrganizationByMoid(response: ResponseContext): Promise<OrganizationOrganization > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: OrganizationOrganization = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getOrganizationOrganizationList
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getOrganizationOrganizationList(response: ResponseContext): Promise<OrganizationOrganizationResponse > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: OrganizationOrganizationResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "OrganizationOrganizationResponse", ""
            ) as OrganizationOrganizationResponse;
            return body;
        }
        if (isCodeInRange("400", response.httpStatusCode)) {
            const body: Error = ObjectSerializer.deserialize(
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to patchOrganizationOrganization
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async patchOrganizationOrganization(response: ResponseContext): Promise<OrganizationOrganization > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: OrganizationOrganization = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to updateOrganizationOrganization
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updateOrganizationOrganization(response: ResponseContext): Promise<OrganizationOrganization > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: OrganizationOrganization = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
