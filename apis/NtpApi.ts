 ...
 * no description
 */
export class NtpApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async createNtpPolicy(ntpPolicy: NtpPolicy, ifMatch?: string, ifNoneMatch?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'ntpPolicy' is not null or undefined
        if (ntpPolicy === null || ntpPolicy === undefined) {
            throw new RequiredError('Required parameter ntpPolicy was null or undefined when calling createNtpPolicy.');
        }
		...
		// Path Params
    	const localVarPath = '/ntp/Policies';
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(ntpPolicy, "NtpPolicy", ""),
            contentType
        );
     ...
     */
    public async deleteNtpPolicy(moid: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling deleteNtpPolicy.');
        }

		
		// Path Params
    	const localVarPath = '/ntp/Policies/{Moid}'
     ...
     * @param moid The unique Moid identifier of a resource instance.
     */
    public async getNtpPolicyByMoid(moid: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling getNtpPolicyByMoid.');
        }
     ...
     */
    public async getNtpPolicyList(filter?: string, orderby?: string, top?: number, skip?: number, select?: string, expand?: string, apply?: string, count?: boolean, inlinecount?: 'allpages' | 'none', at?: string, tags?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
     ...
     * @param ifMatch For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request.
     */
    public async patchNtpPolicy(moid: string, ntpPolicy: NtpPolicy, ifMatch?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling patchNtpPolicy.');
        }

		
        // verify required parameter 'ntpPolicy' is not null or undefined
        if (ntpPolicy === null || ntpPolicy === undefined) {
            throw new RequiredError('Required parameter ntpPolicy was null or undefined when calling patchNtpPolicy.');
        }
     ...
     * @param ifMatch For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request.
     */
    public async updateNtpPolicy(moid: string, ntpPolicy: NtpPolicy, ifMatch?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling updateNtpPolicy.');
        }

		
        // verify required parameter 'ntpPolicy' is not null or undefined
        if (ntpPolicy === null || ntpPolicy === undefined) {
            throw new RequiredError('Required parameter ntpPolicy was null or undefined when calling updateNtpPolicy.');
        }
...
export class NtpApiResponseProcessor {

    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     * @params response Response returned by the server for a request to createNtpPolicy
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async createNtpPolicy(response: ResponseContext): Promise<NtpPolicy > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: NtpPolicy = ObjectSerializer.deserialize(
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to deleteNtpPolicy
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async deleteNtpPolicy(response: ResponseContext): Promise<void > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            return;
        }
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getNtpPolicyByMoid
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getNtpPolicyByMoid(response: ResponseContext): Promise<NtpPolicy > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: NtpPolicy = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getNtpPolicyList
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getNtpPolicyList(response: ResponseContext): Promise<NtpPolicyResponse > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: NtpPolicyResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "NtpPolicyResponse", ""
            ) as NtpPolicyResponse;
            return body;
        }
        if (isCodeInRange("400", response.httpStatusCode)) {
            const body: Error = ObjectSerializer.deserialize(
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to patchNtpPolicy
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async patchNtpPolicy(response: ResponseContext): Promise<NtpPolicy > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: NtpPolicy = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to updateNtpPolicy
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updateNtpPolicy(response: ResponseContext): Promise<NtpPolicy > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: NtpPolicy = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
