 ...
 * no description
 */
export class FcApiRequestFactory extends BaseAPIRequestFactory {
	
    /**
     * Read a 'fc.PhysicalPort' resource.
     * @param moid The unique Moid identifier of a resource instance.
     */
    public async getFcPhysicalPortByMoid(moid: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling getFcPhysicalPortByMoid.');
        }

		
		// Path Params
    	const localVarPath = '/fc/PhysicalPorts/{Moid}'
     ...
     */
    public async getFcPhysicalPortList(filter?: string, orderby?: string, top?: number, skip?: number, select?: string, expand?: string, apply?: string, count?: boolean, inlinecount?: 'allpages' | 'none', at?: string, tags?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		...
		// Path Params
    	const localVarPath = '/fc/PhysicalPorts';
     ...
     */
    public async patchFcPhysicalPort(moid: string, fcPhysicalPort: FcPhysicalPort, ifMatch?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling patchFcPhysicalPort.');
        }

		
        // verify required parameter 'fcPhysicalPort' is not null or undefined
        if (fcPhysicalPort === null || fcPhysicalPort === undefined) {
            throw new RequiredError('Required parameter fcPhysicalPort was null or undefined when calling patchFcPhysicalPort.');
        }
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(fcPhysicalPort, "FcPhysicalPort", ""),
            contentType
        );
     ...
     * @param ifMatch For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request.
     */
    public async updateFcPhysicalPort(moid: string, fcPhysicalPort: FcPhysicalPort, ifMatch?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling updateFcPhysicalPort.');
        }

		
        // verify required parameter 'fcPhysicalPort' is not null or undefined
        if (fcPhysicalPort === null || fcPhysicalPort === undefined) {
            throw new RequiredError('Required parameter fcPhysicalPort was null or undefined when calling updateFcPhysicalPort.');
        }
...
export class FcApiResponseProcessor {

    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getFcPhysicalPortByMoid
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getFcPhysicalPortByMoid(response: ResponseContext): Promise<FcPhysicalPort > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: FcPhysicalPort = ObjectSerializer.deserialize(
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getFcPhysicalPortList
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getFcPhysicalPortList(response: ResponseContext): Promise<FcPhysicalPortResponse > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: FcPhysicalPortResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "FcPhysicalPortResponse", ""
            ) as FcPhysicalPortResponse;
            return body;
        }
        if (isCodeInRange("400", response.httpStatusCode)) {
            const body: Error = ObjectSerializer.deserialize(
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to patchFcPhysicalPort
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async patchFcPhysicalPort(response: ResponseContext): Promise<FcPhysicalPort > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: FcPhysicalPort = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to updateFcPhysicalPort
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updateFcPhysicalPort(response: ResponseContext): Promise<FcPhysicalPort > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: FcPhysicalPort = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
