...
export class MetaApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async deleteMetaDefinition(moid: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling deleteMetaDefinition.');
        }

		
		// Path Params
    	const localVarPath = '/meta/Definitions/{Moid}'
     ...
     * @param moid The unique Moid identifier of a resource instance.
     */
    public async getMetaDefinitionByMoid(moid: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling getMetaDefinitionByMoid.');
        }
     ...
     */
    public async getMetaDefinitionList(filter?: string, orderby?: string, top?: number, skip?: number, select?: string, expand?: string, apply?: string, count?: boolean, inlinecount?: 'allpages' | 'none', at?: string, tags?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		...
		// Path Params
    	const localVarPath = '/meta/Definitions';
...
export class MetaApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to deleteMetaDefinition
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async deleteMetaDefinition(response: ResponseContext): Promise<void > {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getMetaDefinitionByMoid
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getMetaDefinitionByMoid(response: ResponseContext): Promise<MetaDefinition > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: MetaDefinition = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "MetaDefinition", ""
            ) as MetaDefinition;
            return body;
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getMetaDefinitionList
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getMetaDefinitionList(response: ResponseContext): Promise<MetaDefinitionResponse > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: MetaDefinitionResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "MetaDefinitionResponse", ""
            ) as MetaDefinitionResponse;
            return body;
        }
        if (isCodeInRange("400", response.httpStatusCode)) {
            const body: Error = ObjectSerializer.deserialize(
