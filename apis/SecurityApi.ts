...
export class SecurityApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getSecurityUnitByMoid(moid: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling getSecurityUnitByMoid.');
        }

		
		// Path Params
    	const localVarPath = '/security/Units/{Moid}'
     ...
     */
    public async getSecurityUnitList(filter?: string, orderby?: string, top?: number, skip?: number, select?: string, expand?: string, apply?: string, count?: boolean, inlinecount?: 'allpages' | 'none', at?: string, tags?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		...
		// Path Params
    	const localVarPath = '/security/Units';
     ...
     */
    public async patchSecurityUnit(moid: string, securityUnit: SecurityUnit, ifMatch?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling patchSecurityUnit.');
        }

		
        // verify required parameter 'securityUnit' is not null or undefined
        if (securityUnit === null || securityUnit === undefined) {
            throw new RequiredError('Required parameter securityUnit was null or undefined when calling patchSecurityUnit.');
        }
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(securityUnit, "SecurityUnit", ""),
            contentType
        );
     ...
     * @param ifMatch For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request.
     */
    public async updateSecurityUnit(moid: string, securityUnit: SecurityUnit, ifMatch?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling updateSecurityUnit.');
        }

		
        // verify required parameter 'securityUnit' is not null or undefined
        if (securityUnit === null || securityUnit === undefined) {
            throw new RequiredError('Required parameter securityUnit was null or undefined when calling updateSecurityUnit.');
        }
...
export class SecurityApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to getSecurityUnitByMoid
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getSecurityUnitByMoid(response: ResponseContext): Promise<SecurityUnit > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: SecurityUnit = ObjectSerializer.deserialize(
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getSecurityUnitList
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getSecurityUnitList(response: ResponseContext): Promise<SecurityUnitResponse > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: SecurityUnitResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "SecurityUnitResponse", ""
            ) as SecurityUnitResponse;
            return body;
        }
        if (isCodeInRange("400", response.httpStatusCode)) {
            const body: Error = ObjectSerializer.deserialize(
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to patchSecurityUnit
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async patchSecurityUnit(response: ResponseContext): Promise<SecurityUnit > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: SecurityUnit = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to updateSecurityUnit
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updateSecurityUnit(response: ResponseContext): Promise<SecurityUnit > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: SecurityUnit = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
