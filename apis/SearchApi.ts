...
export class SearchApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async createSearchSuggestItem(searchSuggestItem: SearchSuggestItem, ifMatch?: string, ifNoneMatch?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'searchSuggestItem' is not null or undefined
        if (searchSuggestItem === null || searchSuggestItem === undefined) {
            throw new RequiredError('Required parameter searchSuggestItem was null or undefined when calling createSearchSuggestItem.');
        }
		...
		// Path Params
    	const localVarPath = '/search/SuggestItems';
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(searchSuggestItem, "SearchSuggestItem", ""),
            contentType
        );
     ...
     */
    public async getSearchSearchItemByMoid(moid: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling getSearchSearchItemByMoid.');
        }

		
		// Path Params
    	const localVarPath = '/search/SearchItems/{Moid}'
     ...
     */
    public async getSearchSearchItemList(filter?: string, orderby?: string, top?: number, skip?: number, select?: string, expand?: string, apply?: string, count?: boolean, inlinecount?: 'allpages' | 'none', at?: string, tags?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		...
		// Path Params
    	const localVarPath = '/search/SearchItems';
     ...
     * @param moid The unique Moid identifier of a resource instance.
     */
    public async getSearchTagItemByMoid(moid: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling getSearchTagItemByMoid.');
        }

		
		// Path Params
    	const localVarPath = '/search/TagItems/{Moid}'
            .replace('{' + 'Moid' + '}', encodeURIComponent(String(moid)));
     ...
     * @param tags The &#39;tags&#39; parameter is used to request a summary of the Tag utilization for this resource. When the &#39;tags&#39; parameter is specified, the response provides a list of tag keys, the number of times the key has been used across all documents, and the tag values that have been assigned to the tag key.
     */
    public async getSearchTagItemList(filter?: string, orderby?: string, top?: number, skip?: number, select?: string, expand?: string, apply?: string, count?: boolean, inlinecount?: 'allpages' | 'none', at?: string, tags?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		...
		// Path Params
    	const localVarPath = '/search/TagItems';
...
export class SearchApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to createSearchSuggestItem
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async createSearchSuggestItem(response: ResponseContext): Promise<SearchSuggestItem > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: SearchSuggestItem = ObjectSerializer.deserialize(
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getSearchSearchItemByMoid
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getSearchSearchItemByMoid(response: ResponseContext): Promise<SearchSearchItem > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: SearchSearchItem = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "SearchSearchItem", ""
            ) as SearchSearchItem;
            return body;
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getSearchSearchItemList
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getSearchSearchItemList(response: ResponseContext): Promise<SearchSearchItemResponse > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: SearchSearchItemResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "SearchSearchItemResponse", ""
            ) as SearchSearchItemResponse;
            return body;
        }
        if (isCodeInRange("400", response.httpStatusCode)) {
            const body: Error = ObjectSerializer.deserialize(
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getSearchTagItemByMoid
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getSearchTagItemByMoid(response: ResponseContext): Promise<SearchTagItem > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: SearchTagItem = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "SearchTagItem", ""
            ) as SearchTagItem;
            return body;
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getSearchTagItemList
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getSearchTagItemList(response: ResponseContext): Promise<SearchTagItemResponse > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: SearchTagItemResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "SearchTagItemResponse", ""
            ) as SearchTagItemResponse;
            return body;
        }
        if (isCodeInRange("400", response.httpStatusCode)) {
            const body: Error = ObjectSerializer.deserialize(
