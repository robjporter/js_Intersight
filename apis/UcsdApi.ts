 ...
 * no description
 */
export class UcsdApiRequestFactory extends BaseAPIRequestFactory {
	
    /**
     * Delete a 'ucsd.BackupInfo' resource.
     * @param moid The unique Moid identifier of a resource instance.
     */
    public async deleteUcsdBackupInfo(moid: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling deleteUcsdBackupInfo.');
        }

		
		// Path Params
    	const localVarPath = '/ucsd/BackupInfos/{Moid}'
     ...
     * @param moid The unique Moid identifier of a resource instance.
     */
    public async getUcsdBackupInfoByMoid(moid: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling getUcsdBackupInfoByMoid.');
        }
     ...
     */
    public async getUcsdBackupInfoList(filter?: string, orderby?: string, top?: number, skip?: number, select?: string, expand?: string, apply?: string, count?: boolean, inlinecount?: 'allpages' | 'none', at?: string, tags?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		...
		// Path Params
    	const localVarPath = '/ucsd/BackupInfos';
...
export class UcsdApiResponseProcessor {

    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     * @params response Response returned by the server for a request to deleteUcsdBackupInfo
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async deleteUcsdBackupInfo(response: ResponseContext): Promise<void > {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getUcsdBackupInfoByMoid
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getUcsdBackupInfoByMoid(response: ResponseContext): Promise<UcsdBackupInfo > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: UcsdBackupInfo = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "UcsdBackupInfo", ""
            ) as UcsdBackupInfo;
            return body;
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getUcsdBackupInfoList
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getUcsdBackupInfoList(response: ResponseContext): Promise<UcsdBackupInfoResponse > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: UcsdBackupInfoResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "UcsdBackupInfoResponse", ""
            ) as UcsdBackupInfoResponse;
            return body;
        }
        if (isCodeInRange("400", response.httpStatusCode)) {
            const body: Error = ObjectSerializer.deserialize(
