 ...
 * no description
 */
export class SolApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async createSolPolicy(solPolicy: SolPolicy, ifMatch?: string, ifNoneMatch?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'solPolicy' is not null or undefined
        if (solPolicy === null || solPolicy === undefined) {
            throw new RequiredError('Required parameter solPolicy was null or undefined when calling createSolPolicy.');
        }
		...
		// Path Params
    	const localVarPath = '/sol/Policies';
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(solPolicy, "SolPolicy", ""),
            contentType
        );
     ...
     */
    public async deleteSolPolicy(moid: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling deleteSolPolicy.');
        }

		
		// Path Params
    	const localVarPath = '/sol/Policies/{Moid}'
     ...
     * @param moid The unique Moid identifier of a resource instance.
     */
    public async getSolPolicyByMoid(moid: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling getSolPolicyByMoid.');
        }
     ...
     */
    public async getSolPolicyList(filter?: string, orderby?: string, top?: number, skip?: number, select?: string, expand?: string, apply?: string, count?: boolean, inlinecount?: 'allpages' | 'none', at?: string, tags?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
     ...
     * @param ifMatch For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request.
     */
    public async patchSolPolicy(moid: string, solPolicy: SolPolicy, ifMatch?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling patchSolPolicy.');
        }

		
        // verify required parameter 'solPolicy' is not null or undefined
        if (solPolicy === null || solPolicy === undefined) {
            throw new RequiredError('Required parameter solPolicy was null or undefined when calling patchSolPolicy.');
        }
     ...
     * @param ifMatch For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request.
     */
    public async updateSolPolicy(moid: string, solPolicy: SolPolicy, ifMatch?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling updateSolPolicy.');
        }

		
        // verify required parameter 'solPolicy' is not null or undefined
        if (solPolicy === null || solPolicy === undefined) {
            throw new RequiredError('Required parameter solPolicy was null or undefined when calling updateSolPolicy.');
        }
...
export class SolApiResponseProcessor {

    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     * @params response Response returned by the server for a request to createSolPolicy
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async createSolPolicy(response: ResponseContext): Promise<SolPolicy > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: SolPolicy = ObjectSerializer.deserialize(
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to deleteSolPolicy
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async deleteSolPolicy(response: ResponseContext): Promise<void > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            return;
        }
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getSolPolicyByMoid
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getSolPolicyByMoid(response: ResponseContext): Promise<SolPolicy > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: SolPolicy = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getSolPolicyList
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getSolPolicyList(response: ResponseContext): Promise<SolPolicyResponse > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: SolPolicyResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "SolPolicyResponse", ""
            ) as SolPolicyResponse;
            return body;
        }
        if (isCodeInRange("400", response.httpStatusCode)) {
            const body: Error = ObjectSerializer.deserialize(
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to patchSolPolicy
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async patchSolPolicy(response: ResponseContext): Promise<SolPolicy > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: SolPolicy = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to updateSolPolicy
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updateSolPolicy(response: ResponseContext): Promise<SolPolicy > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: SolPolicy = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
