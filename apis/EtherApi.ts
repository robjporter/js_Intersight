 ...
 * no description
 */
export class EtherApiRequestFactory extends BaseAPIRequestFactory {
	
    /**
     * Read a 'ether.PhysicalPort' resource.
     * @param moid The unique Moid identifier of a resource instance.
     */
    public async getEtherPhysicalPortByMoid(moid: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling getEtherPhysicalPortByMoid.');
        }

		
		// Path Params
    	const localVarPath = '/ether/PhysicalPorts/{Moid}'
     ...
     */
    public async getEtherPhysicalPortList(filter?: string, orderby?: string, top?: number, skip?: number, select?: string, expand?: string, apply?: string, count?: boolean, inlinecount?: 'allpages' | 'none', at?: string, tags?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		...
		// Path Params
    	const localVarPath = '/ether/PhysicalPorts';
     ...
     */
    public async patchEtherPhysicalPort(moid: string, etherPhysicalPort: EtherPhysicalPort, ifMatch?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling patchEtherPhysicalPort.');
        }

		
        // verify required parameter 'etherPhysicalPort' is not null or undefined
        if (etherPhysicalPort === null || etherPhysicalPort === undefined) {
            throw new RequiredError('Required parameter etherPhysicalPort was null or undefined when calling patchEtherPhysicalPort.');
        }
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(etherPhysicalPort, "EtherPhysicalPort", ""),
            contentType
        );
     ...
     * @param ifMatch For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request.
     */
    public async updateEtherPhysicalPort(moid: string, etherPhysicalPort: EtherPhysicalPort, ifMatch?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling updateEtherPhysicalPort.');
        }

		
        // verify required parameter 'etherPhysicalPort' is not null or undefined
        if (etherPhysicalPort === null || etherPhysicalPort === undefined) {
            throw new RequiredError('Required parameter etherPhysicalPort was null or undefined when calling updateEtherPhysicalPort.');
        }
...
export class EtherApiResponseProcessor {

    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getEtherPhysicalPortByMoid
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getEtherPhysicalPortByMoid(response: ResponseContext): Promise<EtherPhysicalPort > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: EtherPhysicalPort = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "EtherPhysicalPort", ""
            ) as EtherPhysicalPort;
            return body;
        }
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getEtherPhysicalPortList
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getEtherPhysicalPortList(response: ResponseContext): Promise<EtherPhysicalPortResponse > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: EtherPhysicalPortResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "EtherPhysicalPortResponse", ""
            ) as EtherPhysicalPortResponse;
            return body;
        }
        if (isCodeInRange("400", response.httpStatusCode)) {
            const body: Error = ObjectSerializer.deserialize(
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to patchEtherPhysicalPort
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async patchEtherPhysicalPort(response: ResponseContext): Promise<EtherPhysicalPort > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: EtherPhysicalPort = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to updateEtherPhysicalPort
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updateEtherPhysicalPort(response: ResponseContext): Promise<EtherPhysicalPort > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: EtherPhysicalPort = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
