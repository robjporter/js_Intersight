 ...
 * no description
 */
export class ExternalsiteApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async createExternalsiteAuthorization(externalsiteAuthorization: ExternalsiteAuthorization, ifMatch?: string, ifNoneMatch?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'externalsiteAuthorization' is not null or undefined
        if (externalsiteAuthorization === null || externalsiteAuthorization === undefined) {
            throw new RequiredError('Required parameter externalsiteAuthorization was null or undefined when calling createExternalsiteAuthorization.');
        }
		...
		// Path Params
    	const localVarPath = '/externalsite/Authorizations';
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(externalsiteAuthorization, "ExternalsiteAuthorization", ""),
            contentType
        );
     ...
     */
    public async getExternalsiteAuthorizationByMoid(moid: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling getExternalsiteAuthorizationByMoid.');
        }

		
		// Path Params
    	const localVarPath = '/externalsite/Authorizations/{Moid}'
     ...
     */
    public async getExternalsiteAuthorizationList(filter?: string, orderby?: string, top?: number, skip?: number, select?: string, expand?: string, apply?: string, count?: boolean, inlinecount?: 'allpages' | 'none', at?: string, tags?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
     ...
     * @param ifMatch For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request.
     */
    public async patchExternalsiteAuthorization(moid: string, externalsiteAuthorization: ExternalsiteAuthorization, ifMatch?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling patchExternalsiteAuthorization.');
        }

		
        // verify required parameter 'externalsiteAuthorization' is not null or undefined
        if (externalsiteAuthorization === null || externalsiteAuthorization === undefined) {
            throw new RequiredError('Required parameter externalsiteAuthorization was null or undefined when calling patchExternalsiteAuthorization.');
        }
     ...
     * @param ifMatch For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request.
     */
    public async updateExternalsiteAuthorization(moid: string, externalsiteAuthorization: ExternalsiteAuthorization, ifMatch?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling updateExternalsiteAuthorization.');
        }

		
        // verify required parameter 'externalsiteAuthorization' is not null or undefined
        if (externalsiteAuthorization === null || externalsiteAuthorization === undefined) {
            throw new RequiredError('Required parameter externalsiteAuthorization was null or undefined when calling updateExternalsiteAuthorization.');
        }
...
export class ExternalsiteApiResponseProcessor {

    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     * @params response Response returned by the server for a request to createExternalsiteAuthorization
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async createExternalsiteAuthorization(response: ResponseContext): Promise<ExternalsiteAuthorization > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: ExternalsiteAuthorization = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "ExternalsiteAuthorization", ""
            ) as ExternalsiteAuthorization;
            return body;
        }
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getExternalsiteAuthorizationByMoid
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getExternalsiteAuthorizationByMoid(response: ResponseContext): Promise<ExternalsiteAuthorization > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: ExternalsiteAuthorization = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getExternalsiteAuthorizationList
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getExternalsiteAuthorizationList(response: ResponseContext): Promise<ExternalsiteAuthorizationResponse > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: ExternalsiteAuthorizationResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "ExternalsiteAuthorizationResponse", ""
            ) as ExternalsiteAuthorizationResponse;
            return body;
        }
        if (isCodeInRange("400", response.httpStatusCode)) {
            const body: Error = ObjectSerializer.deserialize(
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to patchExternalsiteAuthorization
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async patchExternalsiteAuthorization(response: ResponseContext): Promise<ExternalsiteAuthorization > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: ExternalsiteAuthorization = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to updateExternalsiteAuthorization
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updateExternalsiteAuthorization(response: ResponseContext): Promise<ExternalsiteAuthorization > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: ExternalsiteAuthorization = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
