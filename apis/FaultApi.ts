 ...
 * no description
 */
export class FaultApiRequestFactory extends BaseAPIRequestFactory {
	
    /**
     * Read a 'fault.Instance' resource.
     * @param moid The unique Moid identifier of a resource instance.
     */
    public async getFaultInstanceByMoid(moid: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling getFaultInstanceByMoid.');
        }

		
		// Path Params
    	const localVarPath = '/fault/Instances/{Moid}'
     ...
     */
    public async getFaultInstanceList(filter?: string, orderby?: string, top?: number, skip?: number, select?: string, expand?: string, apply?: string, count?: boolean, inlinecount?: 'allpages' | 'none', at?: string, tags?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		...
		// Path Params
    	const localVarPath = '/fault/Instances';
     ...
     */
    public async patchFaultInstance(moid: string, faultInstance: FaultInstance, ifMatch?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling patchFaultInstance.');
        }

		
        // verify required parameter 'faultInstance' is not null or undefined
        if (faultInstance === null || faultInstance === undefined) {
            throw new RequiredError('Required parameter faultInstance was null or undefined when calling patchFaultInstance.');
        }
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(faultInstance, "FaultInstance", ""),
            contentType
        );
     ...
     * @param ifMatch For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request.
     */
    public async updateFaultInstance(moid: string, faultInstance: FaultInstance, ifMatch?: string, options?: Configuration): Promise<RequestContext> {
		let config = options || this.configuration;
		
        // verify required parameter 'moid' is not null or undefined
        if (moid === null || moid === undefined) {
            throw new RequiredError('Required parameter moid was null or undefined when calling updateFaultInstance.');
        }

		
        // verify required parameter 'faultInstance' is not null or undefined
        if (faultInstance === null || faultInstance === undefined) {
            throw new RequiredError('Required parameter faultInstance was null or undefined when calling updateFaultInstance.');
        }
...
export class FaultApiResponseProcessor {

    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getFaultInstanceByMoid
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getFaultInstanceByMoid(response: ResponseContext): Promise<FaultInstance > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: FaultInstance = ObjectSerializer.deserialize(
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getFaultInstanceList
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getFaultInstanceList(response: ResponseContext): Promise<FaultInstanceResponse > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: FaultInstanceResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "FaultInstanceResponse", ""
            ) as FaultInstanceResponse;
            return body;
        }
        if (isCodeInRange("400", response.httpStatusCode)) {
            const body: Error = ObjectSerializer.deserialize(
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to patchFaultInstance
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async patchFaultInstance(response: ResponseContext): Promise<FaultInstance > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: FaultInstance = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to updateFaultInstance
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updateFaultInstance(response: ResponseContext): Promise<FaultInstance > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: FaultInstance = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
