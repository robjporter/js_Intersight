...
import { TelemetryDruidDimensionTopNMetricSpec } from './TelemetryDruidDimensionTopNMetricSpec';
import { TelemetryDruidInvertedTopNMetricSpec } from './TelemetryDruidInvertedTopNMetricSpec';
import { TelemetryDruidNumericTopNMetricSpec } from './TelemetryDruidNumericTopNMetricSpec';
import { HttpFile } from '../http/http';

/**
* A Druid TopN metric spec.
*/
export class TelemetryDruidTopNMetricSpec {
    /**
    ...
    */
    'ordering'?: TelemetryDruidTopNMetricSpecOrderingEnum;
    /**
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "type",
            "baseName": "type",
            "type": "TelemetryDruidTopNMetricSpecTypeEnum",
            "format": ""
        },
        {
            "name": "metric",
        ...
        },
        {
            "name": "ordering",
            "baseName": "ordering",
            "type": "TelemetryDruidTopNMetricSpecOrderingEnum",
            "format": ""
        },
        {
            "name": "previousStop",
            "baseName": "previousStop",
            "type": "string",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return TelemetryDruidTopNMetricSpec.attributeTypeMap;
    }
    
    public constructor() {
        this.type = "TelemetryDruidTopNMetricSpec";
    }
}


export type TelemetryDruidTopNMetricSpecTypeEnum = "numeric" | "dimension" | "inverted" ;
export type TelemetryDruidTopNMetricSpecOrderingEnum = "lexicographic" | "alphanumeric" | "numeric" | "strlen" | "version" ;
