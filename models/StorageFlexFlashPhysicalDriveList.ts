...
import { StorageFlexFlashPhysicalDriveListAllOf } from './StorageFlexFlashPhysicalDriveListAllOf';
...
*/
export class StorageFlexFlashPhysicalDriveList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<StorageFlexFlashPhysicalDrive>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<StorageFlexFlashPhysicalDrive>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(StorageFlexFlashPhysicalDriveList.attributeTypeMap);
    }
