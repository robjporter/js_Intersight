...
import { AssetDeviceConfigurationAllOf } from './AssetDeviceConfigurationAllOf';
...
*/
export class AssetDeviceConfiguration extends MoBaseMo {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "localConfigurationLocked",
            "baseName": "LocalConfigurationLocked",
            "type": "boolean",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(AssetDeviceConfiguration.attributeTypeMap);
    }
