...
*/
export class VnicVlanSettingsAllOf {
    /**
    ...
    */
    'mode'?: VnicVlanSettingsAllOfModeEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "mode",
            "baseName": "Mode",
            "type": "VnicVlanSettingsAllOfModeEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return VnicVlanSettingsAllOf.attributeTypeMap;
    }
...
export type VnicVlanSettingsAllOfModeEnum = "ACCESS" | "TRUNK" ;
