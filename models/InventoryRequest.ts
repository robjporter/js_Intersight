...
import { InventoryInventoryMo } from './InventoryInventoryMo';
import { InventoryRequestAllOf } from './InventoryRequestAllOf';
...
*/
export class InventoryRequest extends MoBaseMo {
    'mos'?: Array<InventoryInventoryMo>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "mos",
            "baseName": "Mos",
            "type": "Array<InventoryInventoryMo>",
            "format": ""
        },
        {
            "name": "device",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(InventoryRequest.attributeTypeMap);
    }
