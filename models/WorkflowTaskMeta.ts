...
import { WorkflowTaskMetaAllOf } from './WorkflowTaskMetaAllOf';
import { HttpFile } from '../http/http';

/**
* This MO contains a task definition.
*/
export class WorkflowTaskMeta extends MoBaseMo {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(WorkflowTaskMeta.attributeTypeMap);
    }
