...
export class MetaAccessPrivilegeAllOf {
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "method",
            "baseName": "Method",
            "type": "MetaAccessPrivilegeAllOfMethodEnum",
            "format": ""
        },
        {
            "name": "privilege",
    ...
    static getAttributeTypeMap() {
        return MetaAccessPrivilegeAllOf.attributeTypeMap;
    }
...
export type MetaAccessPrivilegeAllOfMethodEnum = "Update" | "Create" | "Read" | "Delete" ;
