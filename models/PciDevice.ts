...
import { PciDeviceAllOf } from './PciDeviceAllOf';
import { HttpFile } from '../http/http';

/**
* PCI device present in a server.
*/
export class PciDevice extends EquipmentBase {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(PciDevice.attributeTypeMap);
    }
