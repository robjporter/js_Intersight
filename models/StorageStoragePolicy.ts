...
import { StorageDiskGroupPolicyRelationship } from './StorageDiskGroupPolicyRelationship';
import { StorageLocalDisk } from './StorageLocalDisk';
import { StorageStoragePolicyAllOf } from './StorageStoragePolicyAllOf';
import { StorageVirtualDriveConfig } from './StorageVirtualDriveConfig';
...
*/
export class StorageStoragePolicy extends PolicyAbstractPolicy {
    'globalHotSpares'?: Array<StorageLocalDisk>;
    /**
    ...
    */
    'retainPolicyVirtualDrives'?: boolean;
    /**
    ...
    */
    'unusedDisksState'?: StorageStoragePolicyUnusedDisksStateEnum;
    'virtualDrives'?: Array<StorageVirtualDriveConfig>;
    /**
    * An array of relationships to storageDiskGroupPolicy resources.
    */
    'diskGroupPolicies'?: Array<StorageDiskGroupPolicyRelationship>;
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "globalHotSpares",
            "baseName": "GlobalHotSpares",
            "type": "Array<StorageLocalDisk>",
            "format": ""
        },
        {
            "name": "retainPolicyVirtualDrives",
            "baseName": "RetainPolicyVirtualDrives",
            "type": "boolean",
            "format": ""
        },
        {
            "name": "unusedDisksState",
            "baseName": "UnusedDisksState",
            "type": "StorageStoragePolicyUnusedDisksStateEnum",
            "format": ""
        },
        {
            "name": "virtualDrives",
            "baseName": "VirtualDrives",
            "type": "Array<StorageVirtualDriveConfig>",
            "format": ""
        },
        {
            "name": "diskGroupPolicies",
            "baseName": "DiskGroupPolicies",
            "type": "Array<StorageDiskGroupPolicyRelationship>",
            "format": ""
        },
        {
            "name": "organization",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(StorageStoragePolicy.attributeTypeMap);
    }
...
export type StorageStoragePolicyUnusedDisksStateEnum = "UnconfiguredGood" | "Jbod" ;
