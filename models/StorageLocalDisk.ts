...
import { StorageLocalDiskAllOf } from './StorageLocalDiskAllOf';
import { HttpFile } from '../http/http';

/**
* This models disks in the disk group.
*/
export class StorageLocalDisk extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(StorageLocalDisk.attributeTypeMap);
    }
