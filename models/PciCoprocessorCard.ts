...
import { PciCoprocessorCardAllOf } from './PciCoprocessorCardAllOf';
import { HttpFile } from '../http/http';

/**
* PCIe Compression and Cryptographic CPU Offload Card.
*/
export class PciCoprocessorCard extends EquipmentBase {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(PciCoprocessorCard.attributeTypeMap);
    }
