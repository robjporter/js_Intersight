...
import { StoragePureSnapshotSchedule } from './StoragePureSnapshotSchedule';
import { StoragePureSnapshotScheduleListAllOf } from './StoragePureSnapshotScheduleListAllOf';
...
*/
export class StoragePureSnapshotScheduleList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<StoragePureSnapshotSchedule>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<StoragePureSnapshotSchedule>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(StoragePureSnapshotScheduleList.attributeTypeMap);
    }
