...
import { BiosPolicy } from './BiosPolicy';
import { BiosPolicyListAllOf } from './BiosPolicyListAllOf';
...
*/
export class BiosPolicyList extends MoBaseResponse {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<BiosPolicy>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BiosPolicyList.attributeTypeMap);
    }
