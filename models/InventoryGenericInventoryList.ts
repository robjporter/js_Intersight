...
import { InventoryGenericInventoryListAllOf } from './InventoryGenericInventoryListAllOf';
...
*/
export class InventoryGenericInventoryList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<InventoryGenericInventory>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<InventoryGenericInventory>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(InventoryGenericInventoryList.attributeTypeMap);
    }
