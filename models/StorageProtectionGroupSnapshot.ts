...
import { StorageProtectionGroupSnapshotAllOf } from './StorageProtectionGroupSnapshotAllOf';
import { HttpFile } from '../http/http';

/**
* Protection group snapshot entity in protection group.
*/
export class StorageProtectionGroupSnapshot extends MoBaseMo {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(StorageProtectionGroupSnapshot.attributeTypeMap);
    }
