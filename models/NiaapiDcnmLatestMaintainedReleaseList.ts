...
import { NiaapiDcnmLatestMaintainedRelease } from './NiaapiDcnmLatestMaintainedRelease';
import { NiaapiDcnmLatestMaintainedReleaseListAllOf } from './NiaapiDcnmLatestMaintainedReleaseListAllOf';
...
*/
export class NiaapiDcnmLatestMaintainedReleaseList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<NiaapiDcnmLatestMaintainedRelease>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<NiaapiDcnmLatestMaintainedRelease>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(NiaapiDcnmLatestMaintainedReleaseList.attributeTypeMap);
    }
