...
import { PolicyConfigChangeAllOf } from './PolicyConfigChangeAllOf';
import { HttpFile } from '../http/http';

/**
* Defines the configuration changes at the summary level including configuration changes and disruptions.
*/
export class PolicyConfigChange extends MoBaseComplexType {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(PolicyConfigChange.attributeTypeMap);
    }
