...
import { FaultInstanceAllOf } from './FaultInstanceAllOf';
...
*/
export class FaultInstance extends InventoryBase {
    'acknowledged'?: string;
    'affectedDn'?: string;
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(FaultInstance.attributeTypeMap);
    }
