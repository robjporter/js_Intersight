...
import { EquipmentRackEnclosureAllOf } from './EquipmentRackEnclosureAllOf';
...
*/
export class EquipmentRackEnclosure extends EquipmentBase {
    'enclosureId'?: number;
    /**
    ...
    */
    'slots'?: Array<EquipmentRackEnclosureSlotRelationship>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "slots",
            "baseName": "Slots",
            "type": "Array<EquipmentRackEnclosureSlotRelationship>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(EquipmentRackEnclosure.attributeTypeMap);
    }
