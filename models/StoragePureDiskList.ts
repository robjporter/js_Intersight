...
import { StoragePureDisk } from './StoragePureDisk';
import { StoragePureDiskListAllOf } from './StoragePureDiskListAllOf';
...
*/
export class StoragePureDiskList extends MoBaseResponse {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<StoragePureDisk>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(StoragePureDiskList.attributeTypeMap);
    }
