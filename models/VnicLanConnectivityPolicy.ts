...
import { VnicEthIfRelationship } from './VnicEthIfRelationship';
import { VnicLanConnectivityPolicyAllOf } from './VnicLanConnectivityPolicyAllOf';
...
*/
export class VnicLanConnectivityPolicy extends PolicyAbstractPolicy {
    /**
    * An array of relationships to vnicEthIf resources.
    */
    'ethIfs'?: Array<VnicEthIfRelationship>;
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "ethIfs",
            "baseName": "EthIfs",
            "type": "Array<VnicEthIfRelationship>",
            "format": ""
        },
        {
            "name": "organization",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(VnicLanConnectivityPolicy.attributeTypeMap);
    }
