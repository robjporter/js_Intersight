...
import { WorkflowWorkflowMeta } from './WorkflowWorkflowMeta';
import { WorkflowWorkflowMetaListAllOf } from './WorkflowWorkflowMetaListAllOf';
...
*/
export class WorkflowWorkflowMetaList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<WorkflowWorkflowMeta>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<WorkflowWorkflowMeta>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(WorkflowWorkflowMetaList.attributeTypeMap);
    }
