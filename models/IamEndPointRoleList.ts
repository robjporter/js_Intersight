...
import { IamEndPointRoleListAllOf } from './IamEndPointRoleListAllOf';
...
*/
export class IamEndPointRoleList extends MoBaseResponse {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<IamEndPointRole>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(IamEndPointRoleList.attributeTypeMap);
    }
