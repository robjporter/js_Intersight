...
import { FcPhysicalPort } from './FcPhysicalPort';
import { FcPhysicalPortListAllOf } from './FcPhysicalPortListAllOf';
...
*/
export class FcPhysicalPortList extends MoBaseResponse {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<FcPhysicalPort>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(FcPhysicalPortList.attributeTypeMap);
    }
