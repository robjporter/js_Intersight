...
import { GraphicsControllerAllOf } from './GraphicsControllerAllOf';
...
*/
export class GraphicsController extends EquipmentBase {
    /**
    ...
    */
    'pciSlot'?: string;
    'graphicsCard'?: GraphicsCardRelationship;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "graphicsCard",
            "baseName": "GraphicsCard",
            "type": "GraphicsCardRelationship",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(GraphicsController.attributeTypeMap);
    }
