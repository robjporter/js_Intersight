...
import { FirmwareDirectDownload } from './FirmwareDirectDownload';
import { FirmwareDistributableRelationship } from './FirmwareDistributableRelationship';
import { FirmwareNetworkShare } from './FirmwareNetworkShare';
import { FirmwareUpgrade } from './FirmwareUpgrade';
import { FirmwareUpgradeStatusRelationship } from './FirmwareUpgradeStatusRelationship';
...
/**
* A relationship to the 'firmware.Upgrade' resource, or the expanded 'firmware.Upgrade' resource, or the 'null' value.
*/
export class FirmwareUpgradeRelationship {
    /**
    ...
    */
    ...
    'directDownload'?: FirmwareDirectDownload;
    'networkShare'?: FirmwareNetworkShare;
    /**
    * Desired upgrade mode to choose either direct download based upgrade or network share upgrade.
    */
    'upgradeType'?: FirmwareUpgradeRelationshipUpgradeTypeEnum;
    'device'?: AssetDeviceRegistrationRelationship;
    'distributable'?: FirmwareDistributableRelationship;
    'server'?: ComputeRackUnitRelationship;
    'upgradeStatus'?: FirmwareUpgradeStatusRelationship;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "directDownload",
            "baseName": "DirectDownload",
            "type": "FirmwareDirectDownload",
            "format": ""
        },
        {
            "name": "networkShare",
            "baseName": "NetworkShare",
            "type": "FirmwareNetworkShare",
            "format": ""
        },
        {
            "name": "upgradeType",
            "baseName": "UpgradeType",
            "type": "FirmwareUpgradeRelationshipUpgradeTypeEnum",
            "format": ""
        },
        {
            "name": "device",
        ...
        {
            "name": "upgradeStatus",
            "baseName": "UpgradeStatus",
            "type": "FirmwareUpgradeStatusRelationship",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return FirmwareUpgradeRelationship.attributeTypeMap;
    }
...
export type FirmwareUpgradeRelationshipUpgradeTypeEnum = "direct_upgrade" | "network_upgrade" ;
