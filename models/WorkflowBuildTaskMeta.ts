...
import { WorkflowBuildTaskMetaAllOf } from './WorkflowBuildTaskMetaAllOf';
import { HttpFile } from '../http/http';

/**
* Contains relationship for tasks within a workflow. It is used to dynamically generate a workflow.
*/
export class WorkflowBuildTaskMeta extends MoBaseMo {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(WorkflowBuildTaskMeta.attributeTypeMap);
    }
