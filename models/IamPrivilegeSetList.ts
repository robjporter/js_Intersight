...
import { IamPrivilegeSetListAllOf } from './IamPrivilegeSetListAllOf';
...
*/
export class IamPrivilegeSetList extends MoBaseResponse {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<IamPrivilegeSet>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(IamPrivilegeSetList.attributeTypeMap);
    }
