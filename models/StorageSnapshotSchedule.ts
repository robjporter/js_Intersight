...
import { StorageSnapshotScheduleAllOf } from './StorageSnapshotScheduleAllOf';
import { HttpFile } from '../http/http';

/**
* Configuration parameters for snapshot creation at source array.
*/
export class StorageSnapshotSchedule extends MoBaseMo {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(StorageSnapshotSchedule.attributeTypeMap);
    }
