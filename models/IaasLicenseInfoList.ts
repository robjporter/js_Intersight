...
import { IaasLicenseInfoListAllOf } from './IaasLicenseInfoListAllOf';
...
*/
export class IaasLicenseInfoList extends MoBaseResponse {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<IaasLicenseInfo>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(IaasLicenseInfoList.attributeTypeMap);
    }
