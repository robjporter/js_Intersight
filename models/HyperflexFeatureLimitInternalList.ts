...
import { HyperflexFeatureLimitInternal } from './HyperflexFeatureLimitInternal';
import { HyperflexFeatureLimitInternalListAllOf } from './HyperflexFeatureLimitInternalListAllOf';
...
*/
export class HyperflexFeatureLimitInternalList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<HyperflexFeatureLimitInternal>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<HyperflexFeatureLimitInternal>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(HyperflexFeatureLimitInternalList.attributeTypeMap);
    }
