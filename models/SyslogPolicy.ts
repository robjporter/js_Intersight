...
import { SyslogLocalClientBase } from './SyslogLocalClientBase';
import { SyslogPolicyAllOf } from './SyslogPolicyAllOf';
import { SyslogRemoteClientBase } from './SyslogRemoteClientBase';
import { HttpFile } from '../http/http';

/**
* The syslog policy configure the syslog server to receive CIMC log entries.
*/
export class SyslogPolicy extends PolicyAbstractPolicy {
    'localClients'?: Array<SyslogLocalClientBase>;
    'remoteClients'?: Array<SyslogRemoteClientBase>;
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "localClients",
            "baseName": "LocalClients",
            "type": "Array<SyslogLocalClientBase>",
            "format": ""
        },
        {
            "name": "remoteClients",
            "baseName": "RemoteClients",
            "type": "Array<SyslogRemoteClientBase>",
            "format": ""
        },
        {
            "name": "organization",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(SyslogPolicy.attributeTypeMap);
    }
