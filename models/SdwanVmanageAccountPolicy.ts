...
import { SdwanVmanageAccountPolicyAllOf } from './SdwanVmanageAccountPolicyAllOf';
import { HttpFile } from '../http/http';

/**
* A policy specifying vManage account details.
*/
export class SdwanVmanageAccountPolicy extends PolicyAbstractPolicy {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(SdwanVmanageAccountPolicy.attributeTypeMap);
    }
