...
*/
export class VnicEthInterruptSettingsAllOf {
    /**
    ...
    */
    'coalescingType'?: VnicEthInterruptSettingsAllOfCoalescingTypeEnum;
    /**
    ...
    */
    'mode'?: VnicEthInterruptSettingsAllOfModeEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "VnicEthInterruptSettingsAllOfCoalescingTypeEnum",
            "format": ""
        },
        {
            "name": "count",
        ...
        },
        {
            "name": "mode",
            "baseName": "Mode",
            "type": "VnicEthInterruptSettingsAllOfModeEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return VnicEthInterruptSettingsAllOf.attributeTypeMap;
    }
...
export type VnicEthInterruptSettingsAllOfCoalescingTypeEnum = "MIN" | "IDLE" ;
export type VnicEthInterruptSettingsAllOfModeEnum = "MSIx" | "MSI" | "INTx" ;
