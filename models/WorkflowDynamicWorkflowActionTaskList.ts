...
import { WorkflowDynamicWorkflowActionTaskListAllOf } from './WorkflowDynamicWorkflowActionTaskListAllOf';
import { HttpFile } from '../http/http';

/**
* Keeps a list of the tasks to add for a corresponding workflow action when PendingDynamicWorkflowInfo is built.
*/
export class WorkflowDynamicWorkflowActionTaskList extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(WorkflowDynamicWorkflowActionTaskList.attributeTypeMap);
    }
