...
import { PolicyConfigContextAllOf } from './PolicyConfigContextAllOf';
import { HttpFile } from '../http/http';

/**
* Configuration related state and results.
*/
export class PolicyConfigContext extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(PolicyConfigContext.attributeTypeMap);
    }
