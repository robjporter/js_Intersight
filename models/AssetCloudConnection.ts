...
import { AssetCloudConnectionAllOf } from './AssetCloudConnectionAllOf';
...
*/
export class AssetCloudConnection extends AssetConnection {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(AssetCloudConnection.attributeTypeMap);
    }
