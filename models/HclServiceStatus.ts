...
import { HclServiceStatusAllOf } from './HclServiceStatusAllOf';
...
*/
export class HclServiceStatus extends MoBaseMo {
    /**
    * Version of the last modified exemption file.
    */
    'exemptionFileVersion'?: string;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "lastHclDataModifiedTime",
            "baseName": "LastHclDataModifiedTime",
            "type": "Date",
            "format": "date-time"
        },
        {
            "name": "lastImportedDataChecksum",
            "baseName": "LastImportedDataChecksum",
            "type": "string",
            "format": ""
        },
        {
            "name": "status",
            "baseName": "Status",
            "type": "HclServiceStatusStatusEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(HclServiceStatus.attributeTypeMap);
    }
...
export type HclServiceStatusStatusEnum = "Unknown" | "Initializing" | "DataRefreshing" | "Active" ;
