...
import { VirtualizationVmwareDatacenter } from './VirtualizationVmwareDatacenter';
import { VirtualizationVmwareDatacenterListAllOf } from './VirtualizationVmwareDatacenterListAllOf';
...
*/
export class VirtualizationVmwareDatacenterList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<VirtualizationVmwareDatacenter>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<VirtualizationVmwareDatacenter>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(VirtualizationVmwareDatacenterList.attributeTypeMap);
    }
