...
import { WorkflowBuildTaskMetaOwnerAllOf } from './WorkflowBuildTaskMetaOwnerAllOf';
import { HttpFile } from '../http/http';

/**
* Contains the list of dynamic workflow types that a microservice supports.
*/
export class WorkflowBuildTaskMetaOwner extends MoBaseMo {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(WorkflowBuildTaskMetaOwner.attributeTypeMap);
    }
