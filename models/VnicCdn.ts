...
export class VnicCdn extends MoBaseComplexType {
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(VnicCdn.attributeTypeMap);
    }
...
export type VnicCdnSourceEnum = "vnic" | "user" ;
