...
import { MemoryUnitAllOf } from './MemoryUnitAllOf';
...
*/
export class MemoryUnit extends MemoryAbstractUnit {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(MemoryUnit.attributeTypeMap);
    }
