...
import { ConnectorpackConnectorPackUpgrade } from './ConnectorpackConnectorPackUpgrade';
import { ConnectorpackConnectorPackUpgradeListAllOf } from './ConnectorpackConnectorPackUpgradeListAllOf';
...
*/
export class ConnectorpackConnectorPackUpgradeList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<ConnectorpackConnectorPackUpgrade>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<ConnectorpackConnectorPackUpgrade>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(ConnectorpackConnectorPackUpgradeList.attributeTypeMap);
    }
