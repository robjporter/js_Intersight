...
import { ApplianceKeyValuePair } from './ApplianceKeyValuePair';
import { ApplianceSetupInfoAllOf } from './ApplianceSetupInfoAllOf';
...
*/
export class ApplianceSetupInfo extends MoBaseMo {
    /**
    * Build type of the Intersight Appliance setup (e.g. release or debug).
    */
    'buildType'?: string;
    'capabilities'?: Array<ApplianceKeyValuePair>;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "Array<ApplianceKeyValuePair>",
            "format": ""
        },
        {
            "name": "cloudUrl",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(ApplianceSetupInfo.attributeTypeMap);
    }
