...
import { NiaapiDetail } from './NiaapiDetail';
import { NiaapiNiaMetadataAllOf } from './NiaapiNiaMetadataAllOf';
import { HttpFile } from '../http/http';

/**
* Contains the latest Metadata available for download from server.
*/
export class NiaapiNiaMetadata extends MoBaseMo {
    'content'?: Array<NiaapiDetail>;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "metadataChksum",
            "baseName": "MetadataChksum",
            "type": "string",
            "format": ""
        },
        {
            "name": "metadataFilename",
            "baseName": "MetadataFilename",
            "type": "string",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(NiaapiNiaMetadata.attributeTypeMap);
    }
