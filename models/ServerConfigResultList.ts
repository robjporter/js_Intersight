...
import { ServerConfigResultListAllOf } from './ServerConfigResultListAllOf';
...
*/
export class ServerConfigResultList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<ServerConfigResult>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<ServerConfigResult>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(ServerConfigResultList.attributeTypeMap);
    }
