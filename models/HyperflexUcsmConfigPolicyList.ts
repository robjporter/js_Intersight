...
import { HyperflexUcsmConfigPolicy } from './HyperflexUcsmConfigPolicy';
import { HyperflexUcsmConfigPolicyListAllOf } from './HyperflexUcsmConfigPolicyListAllOf';
...
*/
export class HyperflexUcsmConfigPolicyList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<HyperflexUcsmConfigPolicy>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<HyperflexUcsmConfigPolicy>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(HyperflexUcsmConfigPolicyList.attributeTypeMap);
    }
