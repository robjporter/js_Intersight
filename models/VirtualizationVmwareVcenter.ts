...
import { VirtualizationHypervisorManager } from './VirtualizationHypervisorManager';
import { HttpFile } from '../http/http';

/**
* VMware vCenter entity. The vCenter has a name assigned by user in Intersight.
*/
export class VirtualizationVmwareVcenter extends VirtualizationHypervisorManager {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(VirtualizationVmwareVcenter.attributeTypeMap);
    }
