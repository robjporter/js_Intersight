...
import { WorkflowTaskDefinitionListAllOf } from './WorkflowTaskDefinitionListAllOf';
...
*/
export class WorkflowTaskDefinitionList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<WorkflowTaskDefinition>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<WorkflowTaskDefinition>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(WorkflowTaskDefinitionList.attributeTypeMap);
    }
