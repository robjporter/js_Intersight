...
import { VirtualizationVmwareClusterListAllOf } from './VirtualizationVmwareClusterListAllOf';
...
*/
export class VirtualizationVmwareClusterList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<VirtualizationVmwareCluster>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<VirtualizationVmwareCluster>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(VirtualizationVmwareClusterList.attributeTypeMap);
    }
