...
*/
export class SoftwareHclMetaAllOf {
    /**
    * The type of content that the Json file holds (Incremental or full dump).
    */
    'contentType'?: SoftwareHclMetaAllOfContentTypeEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            ...
            "type": "SoftwareHclMetaAllOfContentTypeEnum",
            "format": ""
        },
        {
            "name": "catalog",
    ...
    static getAttributeTypeMap() {
        return SoftwareHclMetaAllOf.attributeTypeMap;
    }
...
export type SoftwareHclMetaAllOfContentTypeEnum = "Full" | "Incremental" ;
