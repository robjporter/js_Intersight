...
import { BootDeviceBase } from './BootDeviceBase';
import { BootPrecisionPolicyAllOf } from './BootPrecisionPolicyAllOf';
...
*/
export class BootPrecisionPolicy extends PolicyAbstractPolicy {
    'bootDevices'?: Array<BootDeviceBase>;
    /**
    ...
    */
    'configuredBootMode'?: BootPrecisionPolicyConfiguredBootModeEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            ...
            "type": "Array<BootDeviceBase>",
            "format": ""
        },
        {
            "name": "configuredBootMode",
            "baseName": "ConfiguredBootMode",
            "type": "BootPrecisionPolicyConfiguredBootModeEnum",
            "format": ""
        },
        {
            "name": "enforceUefiSecureBoot",
            "baseName": "EnforceUefiSecureBoot",
            "type": "boolean",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BootPrecisionPolicy.attributeTypeMap);
    }
...
export type BootPrecisionPolicyConfiguredBootModeEnum = "Legacy" | "Uefi" ;
