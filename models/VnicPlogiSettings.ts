...
import { VnicPlogiSettingsAllOf } from './VnicPlogiSettingsAllOf';
import { HttpFile } from '../http/http';

/**
* Fibre Channel Plogi Settings.
*/
export class VnicPlogiSettings extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(VnicPlogiSettings.attributeTypeMap);
    }
