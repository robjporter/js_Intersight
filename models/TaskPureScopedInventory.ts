...
import { ConnectorScopedInventory } from './ConnectorScopedInventory';
...
import { TaskPureScopedInventoryAllOf } from './TaskPureScopedInventoryAllOf';
import { HttpFile } from '../http/http';

/**
* API to trigger on-demand PureStorage FlashArray inventory to update modified objects in Intersight report.
*/
export class TaskPureScopedInventory extends ConnectorScopedInventory {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(TaskPureScopedInventory.attributeTypeMap);
    }
