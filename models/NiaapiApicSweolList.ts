...
import { NiaapiApicSweol } from './NiaapiApicSweol';
import { NiaapiApicSweolListAllOf } from './NiaapiApicSweolListAllOf';
...
*/
export class NiaapiApicSweolList extends MoBaseResponse {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<NiaapiApicSweol>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(NiaapiApicSweolList.attributeTypeMap);
    }
