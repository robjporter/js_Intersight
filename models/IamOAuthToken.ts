...
import { IamClientMeta } from './IamClientMeta';
import { IamOAuthTokenAllOf } from './IamOAuthTokenAllOf';
...
*/
export class IamOAuthToken extends MoBaseMo {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(IamOAuthToken.attributeTypeMap);
    }
