...
import { VirtualizationVmDiskCommitInfoAllOf } from './VirtualizationVmDiskCommitInfoAllOf';
...
*/
export class VirtualizationVmDiskCommitInfo extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "committedDisk",
            "baseName": "CommittedDisk",
            "type": "number",
            "format": "int64"
        },
        {
            "name": "unCommittedDisk",
            "baseName": "UnCommittedDisk",
            "type": "number",
            "format": "int64"
        },
        {
            "name": "unsharedDisk",
            "baseName": "UnsharedDisk",
            "type": "number",
            "format": "int64"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(VirtualizationVmDiskCommitInfo.attributeTypeMap);
    }
