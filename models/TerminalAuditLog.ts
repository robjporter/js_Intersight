...
import { AssetDeviceConnectionRelationship } from './AssetDeviceConnectionRelationship';
...
import { TerminalAuditLogAllOf } from './TerminalAuditLogAllOf';
import { HttpFile } from '../http/http';

/**
* Audit log of remote terminal user sessions.
*/
export class TerminalAuditLog extends MoBaseMo {
    /**
    ...
    */
    'startTime'?: Date;
    'deviceRegistration'?: AssetDeviceConnectionRelationship;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "AssetDeviceConnectionRelationship",
            "format": ""
        },
        {
            "name": "user",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(TerminalAuditLog.attributeTypeMap);
    }
