...
import { EquipmentFexAllOf } from './EquipmentFexAllOf';
...
*/
export class EquipmentFex extends EquipmentBase {
    'operState'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(EquipmentFex.attributeTypeMap);
    }
