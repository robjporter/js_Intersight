...
import { BiosBootModeAllOf } from './BiosBootModeAllOf';
...
*/
export class BiosBootMode extends InventoryBase {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BiosBootMode.attributeTypeMap);
    }
