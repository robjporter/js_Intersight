...
import { ComputeServerConfigAllOf } from './ComputeServerConfigAllOf';
...
*/
export class ComputeServerConfig extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(ComputeServerConfig.attributeTypeMap);
    }
