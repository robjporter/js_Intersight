...
import { CondAlarm } from './CondAlarm';
import { CondAlarmListAllOf } from './CondAlarmListAllOf';
...
*/
export class CondAlarmList extends MoBaseResponse {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<CondAlarm>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(CondAlarmList.attributeTypeMap);
    }
