...
import { StorageStorageUtilizationAllOf } from './StorageStorageUtilizationAllOf';
import { HttpFile } from '../http/http';

/**
* Storage space utilized by Pure storage entity.
*/
export class StorageStorageUtilization extends StorageCapacity {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(StorageStorageUtilization.attributeTypeMap);
    }
