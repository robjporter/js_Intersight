...
import { SmtpPolicyAllOf } from './SmtpPolicyAllOf';
import { HttpFile } from '../http/http';

/**
* Name that identifies the SMTP Policy.
*/
export class SmtpPolicy extends PolicyAbstractPolicy {
    /**
    ...
    */
    'minSeverity'?: SmtpPolicyMinSeverityEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "SmtpPolicyMinSeverityEnum",
            "format": ""
        },
        {
            "name": "senderEmail",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(SmtpPolicy.attributeTypeMap);
    }
...
export type SmtpPolicyMinSeverityEnum = "critical" | "condition" | "warning" | "minor" | "major" ;
