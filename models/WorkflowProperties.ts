...
import { WorkflowPropertiesAllOf } from './WorkflowPropertiesAllOf';
...
*/
export class WorkflowProperties extends MoBaseComplexType {
    /**
    ...
    */
    'retryPolicy'?: WorkflowPropertiesRetryPolicyEnum;
    /**
    * Supported status of the definition.
    */
    'supportStatus'?: WorkflowPropertiesSupportStatusEnum;
    /**
    ...
    */
    'timeoutPolicy'?: WorkflowPropertiesTimeoutPolicyEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "WorkflowPropertiesRetryPolicyEnum",
            "format": ""
        },
        {
            "name": "supportStatus",
            "baseName": "SupportStatus",
            "type": "WorkflowPropertiesSupportStatusEnum",
            "format": ""
        },
        {
            "name": "timeout",
        ...
        },
        {
            ...
            "type": "WorkflowPropertiesTimeoutPolicyEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(WorkflowProperties.attributeTypeMap);
    }
...
export type WorkflowPropertiesRetryPolicyEnum = "Fixed" ;
export type WorkflowPropertiesSupportStatusEnum = "Supported" | "Beta" | "Deprecated" ;
export type WorkflowPropertiesTimeoutPolicyEnum = "Timeout" | "Retry" ;
