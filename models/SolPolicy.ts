...
import { SolPolicyAllOf } from './SolPolicyAllOf';
import { HttpFile } from '../http/http';

/**
* Policy for configuring Serial Over LAN settings on endpoint.
*/
export class SolPolicy extends PolicyAbstractPolicy {
    /**
    * Baud Rate used for Serial Over LAN communication.
    */
    'baudRate'?: SolPolicyBaudRateEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "baudRate",
            "baseName": "BaudRate",
            "type": "SolPolicyBaudRateEnum",
            "format": ""
        },
        {
            "name": "comPort",
            "baseName": "ComPort",
            "type": "SolPolicyComPortEnum",
            "format": ""
        },
        {
            "name": "enabled",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(SolPolicy.attributeTypeMap);
    }
...
export type SolPolicyBaudRateEnum = "9600" | "19200" | "38400" | "57600" | "115200" ;
export type SolPolicyComPortEnum = "com0" | "com1" ;
