...
import { StoragePhysicalDiskUsageAllOf } from './StoragePhysicalDiskUsageAllOf';
import { HttpFile } from '../http/http';

/**
* Has usage map between physical disks and virtual drives.
*/
export class StoragePhysicalDiskUsage extends InventoryBase {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(StoragePhysicalDiskUsage.attributeTypeMap);
    }
