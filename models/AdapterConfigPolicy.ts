...
import { AdapterAdapterConfig } from './AdapterAdapterConfig';
import { AdapterConfigPolicyAllOf } from './AdapterConfigPolicyAllOf';
...
*/
export class AdapterConfigPolicy extends PolicyAbstractPolicy {
    'settings'?: Array<AdapterAdapterConfig>;
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "settings",
            "baseName": "Settings",
            "type": "Array<AdapterAdapterConfig>",
            "format": ""
        },
        {
            "name": "organization",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(AdapterConfigPolicy.attributeTypeMap);
    }
