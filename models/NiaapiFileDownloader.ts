...
import { NiaapiFileDownloaderAllOf } from './NiaapiFileDownloaderAllOf';
import { HttpFile } from '../http/http';

/**
* Provide a presigned url to download the metadata file from server.
*/
export class NiaapiFileDownloader extends MoBaseMo {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(NiaapiFileDownloader.attributeTypeMap);
    }
