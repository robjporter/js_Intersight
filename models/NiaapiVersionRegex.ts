...
import { NiaapiVersionRegexAllOf } from './NiaapiVersionRegexAllOf';
import { NiaapiVersionRegexPlatform } from './NiaapiVersionRegexPlatform';
import { HttpFile } from '../http/http';

/**
* The regular expression pattern to recongnize the version string.
*/
export class NiaapiVersionRegex extends MoBaseMo {
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(NiaapiVersionRegex.attributeTypeMap);
    }
