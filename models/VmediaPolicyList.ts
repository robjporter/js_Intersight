...
import { VmediaPolicy } from './VmediaPolicy';
import { VmediaPolicyListAllOf } from './VmediaPolicyListAllOf';
...
*/
export class VmediaPolicyList extends MoBaseResponse {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<VmediaPolicy>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(VmediaPolicyList.attributeTypeMap);
    }
