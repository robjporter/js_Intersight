...
import { WorkflowEnumEntryAllOf } from './WorkflowEnumEntryAllOf';
import { HttpFile } from '../http/http';

/**
* Captures a single enum entry which has a label and value.
*/
export class WorkflowEnumEntry extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(WorkflowEnumEntry.attributeTypeMap);
    }
