...
import { IpmioverlanPolicyAllOf } from './IpmioverlanPolicyAllOf';
...
*/
export class IpmioverlanPolicy extends PolicyAbstractPolicy {
    /**
    ...
    */
    'privilege'?: IpmioverlanPolicyPrivilegeEnum;
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "isEncryptionKeySet",
            "baseName": "IsEncryptionKeySet",
            "type": "boolean",
            "format": ""
        },
        {
            "name": "privilege",
            "baseName": "Privilege",
            "type": "IpmioverlanPolicyPrivilegeEnum",
            "format": ""
        },
        {
            "name": "organization",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(IpmioverlanPolicy.attributeTypeMap);
    }
...
export type IpmioverlanPolicyPrivilegeEnum = "admin" | "user" | "read-only" ;
