...
import { NtpPolicyAllOf } from './NtpPolicyAllOf';
...
*/
export class NtpPolicy extends PolicyAbstractPolicy {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(NtpPolicy.attributeTypeMap);
    }
