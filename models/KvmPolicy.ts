...
import { KvmPolicyAllOf } from './KvmPolicyAllOf';
...
*/
export class KvmPolicy extends PolicyAbstractPolicy {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "enableLocalServerVideo",
            "baseName": "EnableLocalServerVideo",
            "type": "boolean",
            "format": ""
        },
        {
            "name": "enableVideoEncryption",
            "baseName": "EnableVideoEncryption",
            "type": "boolean",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(KvmPolicy.attributeTypeMap);
    }
