...
import { ConnectorpackConnectorPackUpdate } from './ConnectorpackConnectorPackUpdate';
import { ConnectorpackUpgradeImpactAllOf } from './ConnectorpackUpgradeImpactAllOf';
...
*/
export class ConnectorpackUpgradeImpact extends MoBaseMo {
    'connectorPack'?: Array<ConnectorpackConnectorPackUpdate>;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            ...
            "type": "Array<ConnectorpackConnectorPackUpdate>",
            "format": ""
        },
        {
            "name": "isEligibleForUpgrade",
            "baseName": "IsEligibleForUpgrade",
            "type": "boolean",
            "format": ""
        },
        {
            "name": "isUpdateDownloaded",
            "baseName": "IsUpdateDownloaded",
            "type": "boolean",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(ConnectorpackUpgradeImpact.attributeTypeMap);
    }
