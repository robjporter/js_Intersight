...
import { VnicVmqSettingsAllOf } from './VnicVmqSettingsAllOf';
...
*/
export class VnicVmqSettings extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(VnicVmqSettings.attributeTypeMap);
    }
