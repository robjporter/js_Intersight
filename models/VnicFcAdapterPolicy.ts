...
import { VnicFcAdapterPolicyAllOf } from './VnicFcAdapterPolicyAllOf';
...
*/
export class VnicFcAdapterPolicy extends PolicyAbstractPolicy {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(VnicFcAdapterPolicy.attributeTypeMap);
    }
