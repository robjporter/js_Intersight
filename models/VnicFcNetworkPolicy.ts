...
import { VnicFcNetworkPolicyAllOf } from './VnicFcNetworkPolicyAllOf';
import { VnicVsanSettings } from './VnicVsanSettings';
import { HttpFile } from '../http/http';

/**
* A Fibre Channel Network policy governs the VSAN configuration for the virtual interfaces.
*/
export class VnicFcNetworkPolicy extends PolicyAbstractPolicy {
    'vsanSettings'?: VnicVsanSettings;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(VnicFcNetworkPolicy.attributeTypeMap);
    }
