...
import { StorageSasExpanderAllOf } from './StorageSasExpanderAllOf';
import { HttpFile } from '../http/http';

/**
* SAS Expander present in a server.
*/
export class StorageSasExpander extends EquipmentBase {
    'expanderId'?: number;
    'name'?: string;
    'operState'?: string;
    'operability'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(StorageSasExpander.attributeTypeMap);
    }
