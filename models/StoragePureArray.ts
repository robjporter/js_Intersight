...
import { StoragePureArrayAllOf } from './StoragePureArrayAllOf';
import { HttpFile } from '../http/http';

/**
* The details of the Pure storage array.
*/
export class StoragePureArray extends StorageGenericArray {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(StoragePureArray.attributeTypeMap);
    }
