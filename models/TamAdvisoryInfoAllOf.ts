...
export class TamAdvisoryInfoAllOf {
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "state",
            "baseName": "State",
            "type": "TamAdvisoryInfoAllOfStateEnum",
            "format": ""
        },
        {
            "name": "account",
    ...
    static getAttributeTypeMap() {
        return TamAdvisoryInfoAllOf.attributeTypeMap;
    }
...
export type TamAdvisoryInfoAllOfStateEnum = "active" | "acknowledged" ;
