...
import { PolicyinventoryAbstractDeviceInfo } from './PolicyinventoryAbstractDeviceInfo';
...
*/
export class InventoryDeviceInfo extends PolicyinventoryAbstractDeviceInfo {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(InventoryDeviceInfo.attributeTypeMap);
    }
