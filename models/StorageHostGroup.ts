...
import { StorageHostGroupAllOf } from './StorageHostGroupAllOf';
import { HttpFile } from '../http/http';

/**
* Generic representation for a group of hosts.
*/
export class StorageHostGroup extends MoBaseMo {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(StorageHostGroup.attributeTypeMap);
    }
