...
import { IamUserPreferenceAllOf } from './IamUserPreferenceAllOf';
...
*/
export class IamUserPreference extends MoBaseMo {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(IamUserPreference.attributeTypeMap);
    }
