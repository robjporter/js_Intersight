...
import { PolicyConfigResultContextAllOf } from './PolicyConfigResultContextAllOf';
import { HttpFile } from '../http/http';

/**
* The context for a validation/config result such as the related entity's name, type, MOID etc.
*/
export class PolicyConfigResultContext extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(PolicyConfigResultContext.attributeTypeMap);
    }
