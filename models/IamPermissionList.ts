...
import { IamPermissionListAllOf } from './IamPermissionListAllOf';
...
*/
export class IamPermissionList extends MoBaseResponse {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(IamPermissionList.attributeTypeMap);
    }
