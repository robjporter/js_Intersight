...
import { AssetClusterMemberListAllOf } from './AssetClusterMemberListAllOf';
...
*/
export class AssetClusterMemberList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<AssetClusterMember>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<AssetClusterMember>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(AssetClusterMemberList.attributeTypeMap);
    }
