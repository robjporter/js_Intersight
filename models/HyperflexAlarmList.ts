...
import { HyperflexAlarmListAllOf } from './HyperflexAlarmListAllOf';
...
*/
export class HyperflexAlarmList extends MoBaseResponse {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<HyperflexAlarm>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(HyperflexAlarmList.attributeTypeMap);
    }
