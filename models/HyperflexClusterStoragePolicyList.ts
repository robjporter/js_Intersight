...
import { HyperflexClusterStoragePolicy } from './HyperflexClusterStoragePolicy';
import { HyperflexClusterStoragePolicyListAllOf } from './HyperflexClusterStoragePolicyListAllOf';
...
*/
export class HyperflexClusterStoragePolicyList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<HyperflexClusterStoragePolicy>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<HyperflexClusterStoragePolicy>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(HyperflexClusterStoragePolicyList.attributeTypeMap);
    }
