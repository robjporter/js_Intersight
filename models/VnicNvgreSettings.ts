...
import { VnicNvgreSettingsAllOf } from './VnicNvgreSettingsAllOf';
import { HttpFile } from '../http/http';

/**
* Network Virtualization using Generic Routing Encapsulation Settings.
*/
export class VnicNvgreSettings extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(VnicNvgreSettings.attributeTypeMap);
    }
