...
export class StoragePureDisk extends StorageArrayDisk {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(StoragePureDisk.attributeTypeMap);
    }
