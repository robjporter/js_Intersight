...
import { I18nMessageAllOf } from './I18nMessageAllOf';
import { I18nMessageParam } from './I18nMessageParam';
...
*/
export class I18nMessage extends MoBaseComplexType {
    /**
    ...
    */
    'messageId'?: string;
    'messageParams'?: Array<I18nMessageParam>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "Array<I18nMessageParam>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(I18nMessage.attributeTypeMap);
    }
