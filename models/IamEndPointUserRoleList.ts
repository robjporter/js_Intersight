...
import { IamEndPointUserRoleListAllOf } from './IamEndPointUserRoleListAllOf';
...
*/
export class IamEndPointUserRoleList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<IamEndPointUserRole>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<IamEndPointUserRole>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(IamEndPointUserRoleList.attributeTypeMap);
    }
