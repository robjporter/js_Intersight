...
import { VnicUsnicSettingsAllOf } from './VnicUsnicSettingsAllOf';
...
*/
export class VnicUsnicSettings extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "usnicAdapterPolicy",
            "baseName": "UsnicAdapterPolicy",
            "type": "string",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(VnicUsnicSettings.attributeTypeMap);
    }
