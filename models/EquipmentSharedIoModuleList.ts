...
import { EquipmentSharedIoModule } from './EquipmentSharedIoModule';
import { EquipmentSharedIoModuleListAllOf } from './EquipmentSharedIoModuleListAllOf';
...
*/
export class EquipmentSharedIoModuleList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<EquipmentSharedIoModule>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<EquipmentSharedIoModule>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(EquipmentSharedIoModuleList.attributeTypeMap);
    }
