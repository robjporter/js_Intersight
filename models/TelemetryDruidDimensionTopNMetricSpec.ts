...
import { TelemetryDruidBaseTopNMetricSpec } from './TelemetryDruidBaseTopNMetricSpec';
import { TelemetryDruidDimensionTopNMetricSpecAllOf } from './TelemetryDruidDimensionTopNMetricSpecAllOf';
import { HttpFile } from '../http/http';

/**
* This metric specification sorts TopN results by dimension value, using one of the sorting orders.
*/
export class TelemetryDruidDimensionTopNMetricSpec {
    /**
    * The dimension spec type.
    */
    'type': TelemetryDruidDimensionTopNMetricSpecTypeEnum;
    /**
    ...
    */
    'ordering'?: TelemetryDruidDimensionTopNMetricSpecOrderingEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "ordering",
            "baseName": "ordering",
            "type": "TelemetryDruidDimensionTopNMetricSpecOrderingEnum",
            "format": ""
        },
        {
            "name": "previousStop",
    ...
    static getAttributeTypeMap() {
        return TelemetryDruidDimensionTopNMetricSpec.attributeTypeMap;
    }
...
export type TelemetryDruidDimensionTopNMetricSpecTypeEnum = "numeric" | "dimension" | "inverted" ;
export type TelemetryDruidDimensionTopNMetricSpecOrderingEnum = "lexicographic" | "alphanumeric" | "numeric" | "strlen" | "version" ;
