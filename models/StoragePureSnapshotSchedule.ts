...
import { StoragePureSnapshotScheduleAllOf } from './StoragePureSnapshotScheduleAllOf';
import { StorageSnapshotSchedule } from './StorageSnapshotSchedule';
import { HttpFile } from '../http/http';

/**
* PureStorage FlashArray snapshot schedule configuration entity.
*/
export class StoragePureSnapshotSchedule extends StorageSnapshotSchedule {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(StoragePureSnapshotSchedule.attributeTypeMap);
    }
