...
*/
export class SoftwarerepositoryFileServer extends MoBaseComplexType {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(SoftwarerepositoryFileServer.attributeTypeMap);
    }
