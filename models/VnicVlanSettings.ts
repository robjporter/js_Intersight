...
import { VnicVlanSettingsAllOf } from './VnicVlanSettingsAllOf';
import { HttpFile } from '../http/http';

/**
* VLAN configuration for the virtual interface.
*/
export class VnicVlanSettings extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "mode",
            "baseName": "Mode",
            "type": "VnicVlanSettingsModeEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(VnicVlanSettings.attributeTypeMap);
    }
...
export type VnicVlanSettingsModeEnum = "ACCESS" | "TRUNK" ;
