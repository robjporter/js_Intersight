...
import { TamActionAllOf } from './TamActionAllOf';
import { TamIdentifiers } from './TamIdentifiers';
import { TamQueryEntry } from './TamQueryEntry';
...
*/
export class TamAction extends MoBaseComplexType {
    /**
    ...
    */
    'alertType'?: TamActionAlertTypeEnum;
    ...
    */
    'operationType'?: TamActionOperationTypeEnum;
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "alertType",
            "baseName": "AlertType",
            "type": "TamActionAlertTypeEnum",
            "format": ""
        },
        {
            "name": "identifiers",
            "baseName": "Identifiers",
            "type": "Array<TamIdentifiers>",
            "format": ""
        },
        {
            "name": "name",
        ...
        },
        {
            ...
            "type": "TamActionOperationTypeEnum",
            "format": ""
        },
        {
            "name": "queries",
            "baseName": "Queries",
            "type": "Array<TamQueryEntry>",
            "format": ""
        },
        {
            "name": "type",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(TamAction.attributeTypeMap);
    }
...
export type TamActionAlertTypeEnum = "psirt" | "fieldNotice" ;
export type TamActionOperationTypeEnum = "create" | "remove" ;
export type TamActionTypeEnum = "restApi" ;
