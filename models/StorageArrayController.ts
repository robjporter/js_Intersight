...
import { StorageArrayControllerAllOf } from './StorageArrayControllerAllOf';
...
*/
export class StorageArrayController extends EquipmentBase {
    /**
    ...
    */
    'operationalMode'?: StorageArrayControllerOperationalModeEnum;
    /**
    * Status of the storage controller.
    */
    'status'?: StorageArrayControllerStatusEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "StorageArrayControllerOperationalModeEnum",
            "format": ""
        },
        {
            "name": "status",
            "baseName": "Status",
            "type": "StorageArrayControllerStatusEnum",
            "format": ""
        },
        {
            "name": "version",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(StorageArrayController.attributeTypeMap);
    }
...
export type StorageArrayControllerOperationalModeEnum = "Unknown" | "Primary" | "Secondary" | "Maintenance" ;
export type StorageArrayControllerStatusEnum = "Unknown" | "Ok" | "Degraded" | "Critical" | "Offline" | "Identifying" | "NotAvailable" | "Updating" | "Unrecognized" ;
