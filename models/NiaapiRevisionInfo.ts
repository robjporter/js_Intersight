...
import { NiaapiRevisionInfoAllOf } from './NiaapiRevisionInfoAllOf';
import { HttpFile } from '../http/http';

/**
* The Revision info including date comment and revision number.
*/
export class NiaapiRevisionInfo extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(NiaapiRevisionInfo.attributeTypeMap);
    }
