...
import { NiaapiNewReleaseDetailAllOf } from './NiaapiNewReleaseDetailAllOf';
import { HttpFile } from '../http/http';

/**
* The detail content of of this post.
*/
export class NiaapiNewReleaseDetail extends MoBaseComplexType {
    /**
    ...
    */
    'softwareDownloadLinkTitle'?: string;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "baseName": "ReleaseNoteLink",
            "type": "string",
            "format": ""
        },
        {
            "name": "releaseNoteLinkTitle",
            "baseName": "ReleaseNoteLinkTitle",
            "type": "string",
            "format": ""
        },
        {
            "name": "softwareDownloadLink",
            "baseName": "SoftwareDownloadLink",
            "type": "string",
            "format": ""
        },
        {
            "name": "softwareDownloadLinkTitle",
            "baseName": "SoftwareDownloadLinkTitle",
            "type": "string",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(NiaapiNewReleaseDetail.attributeTypeMap);
    }
