...
import { WorkflowTaskConstraintsAllOf } from './WorkflowTaskConstraintsAllOf';
...
*/
export class WorkflowTaskConstraints extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "targetDataType",
            "baseName": "TargetDataType",
            "type": "AnyType",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(WorkflowTaskConstraints.attributeTypeMap);
    }
