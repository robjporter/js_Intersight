...
import { AssetUsernamePasswordCredentialAllOf } from './AssetUsernamePasswordCredentialAllOf';
import { HttpFile } from '../http/http';

/**
* An credential which performs authentication based on a username and password.
*/
export class AssetUsernamePasswordCredential extends AssetCredential {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(AssetUsernamePasswordCredential.attributeTypeMap);
    }
