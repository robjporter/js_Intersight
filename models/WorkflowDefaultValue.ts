...
import { WorkflowDefaultValueAllOf } from './WorkflowDefaultValueAllOf';
import { HttpFile } from '../http/http';

/**
* Captures default vales for a data type.
*/
export class WorkflowDefaultValue extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(WorkflowDefaultValue.attributeTypeMap);
    }
