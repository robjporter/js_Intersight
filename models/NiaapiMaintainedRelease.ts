...
import { NiaapiMaintainedReleaseAllOf } from './NiaapiMaintainedReleaseAllOf';
import { HttpFile } from '../http/http';

/**
* This contains the latest maintained release based on current running software release.
*/
export class NiaapiMaintainedRelease extends MoBaseMo {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "maintainedRelease",
            "baseName": "MaintainedRelease",
            "type": "string",
            "format": ""
        },
        {
            "name": "softwareRelease",
            "baseName": "SoftwareRelease",
            "type": "string",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(NiaapiMaintainedRelease.attributeTypeMap);
    }
