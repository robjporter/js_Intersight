...
*/
export class VnicFcInterruptSettingsAllOf {
    /**
    ...
    */
    'mode'?: VnicFcInterruptSettingsAllOfModeEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "mode",
            "baseName": "Mode",
            "type": "VnicFcInterruptSettingsAllOfModeEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return VnicFcInterruptSettingsAllOf.attributeTypeMap;
    }
...
export type VnicFcInterruptSettingsAllOfModeEnum = "MSIx" | "MSI" | "INTx" ;
