...
import { AdapterHostFcInterfaceAllOf } from './AdapterHostFcInterfaceAllOf';
...
*/
export class AdapterHostFcInterface extends EquipmentBase {
    'adminState'?: string;
    'epDn'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "hostFcInterfaceId",
            "baseName": "HostFcInterfaceId",
            "type": "number",
            "format": "int64"
        },
        {
        ...
        {
            "name": "originalWwnn",
            "baseName": "OriginalWwnn",
            "type": "string",
            "format": ""
        },
        {
            "name": "originalWwpn",
            "baseName": "OriginalWwpn",
            "type": "string",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(AdapterHostFcInterface.attributeTypeMap);
    }
