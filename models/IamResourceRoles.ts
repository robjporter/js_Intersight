...
import { IamResourceRolesAllOf } from './IamResourceRolesAllOf';
...
*/
export class IamResourceRoles extends MoBaseMo {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(IamResourceRoles.attributeTypeMap);
    }
