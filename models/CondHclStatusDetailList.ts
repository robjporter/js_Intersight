...
import { CondHclStatusDetailListAllOf } from './CondHclStatusDetailListAllOf';
...
*/
export class CondHclStatusDetailList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<CondHclStatusDetail>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<CondHclStatusDetail>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(CondHclStatusDetailList.attributeTypeMap);
    }
