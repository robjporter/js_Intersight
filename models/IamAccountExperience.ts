...
import { IamAccountExperienceAllOf } from './IamAccountExperienceAllOf';
import { IamAccountRelationship } from './IamAccountRelationship';
import { IamFeatureDefinition } from './IamFeatureDefinition';
...
*/
export class IamAccountExperience extends MoBaseMo {
    'features'?: Array<IamFeatureDefinition>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "features",
            "baseName": "Features",
            "type": "Array<IamFeatureDefinition>",
            "format": ""
        },
        {
            "name": "account",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(IamAccountExperience.attributeTypeMap);
    }
