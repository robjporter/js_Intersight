...
import { IamAccountPermissions } from './IamAccountPermissions';
import { IamPermissionRelationship } from './IamPermissionRelationship';
import { IamSessionAllOf } from './IamSessionAllOf';
...
*/
export class IamSession extends MoBaseMo {
    'accountPermissions'?: Array<IamAccountPermissions>;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            ...
            "type": "Array<IamAccountPermissions>",
            "format": ""
        },
        {
        ...
        {
            "name": "idleTimeExpiration",
            "baseName": "IdleTimeExpiration",
            "type": "Date",
            "format": "date-time"
        },
        {
            "name": "lastLoginClient",
            "baseName": "LastLoginClient",
            "type": "string",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(IamSession.attributeTypeMap);
    }
