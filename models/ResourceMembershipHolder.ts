...
import { ResourceMembershipHolderAllOf } from './ResourceMembershipHolderAllOf';
import { ResourceMembershipRelationship } from './ResourceMembershipRelationship';
import { HttpFile } from '../http/http';

/**
* A holder of REST resources and their membership.
*/
export class ResourceMembershipHolder extends MoBaseMo {
    /**
    ...
    */
    'memberships'?: Array<ResourceMembershipRelationship>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "Array<ResourceMembershipRelationship>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(ResourceMembershipHolder.attributeTypeMap);
    }
