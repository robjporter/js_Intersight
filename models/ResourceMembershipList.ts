...
import { ResourceMembershipListAllOf } from './ResourceMembershipListAllOf';
...
*/
export class ResourceMembershipList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<ResourceMembership>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<ResourceMembership>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(ResourceMembershipList.attributeTypeMap);
    }
