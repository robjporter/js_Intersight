...
export class WorkflowValidationInformationAllOf {
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "state",
            "baseName": "State",
            "type": "WorkflowValidationInformationAllOfStateEnum",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return WorkflowValidationInformationAllOf.attributeTypeMap;
    }
...
export type WorkflowValidationInformationAllOfStateEnum = "NotValidated" | "Valid" | "Invalid" ;
