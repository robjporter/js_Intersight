...
import { IamEndPointUserAllOf } from './IamEndPointUserAllOf';
...
*/
export class IamEndPointUser extends MoBaseMo {
    /**
    ...
    */
    'endPointUserRole'?: Array<IamEndPointUserRoleRelationship>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "endPointUserRole",
            "baseName": "EndPointUserRole",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(IamEndPointUser.attributeTypeMap);
    }
