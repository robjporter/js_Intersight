...
import { ResourceSelectorAllOf } from './ResourceSelectorAllOf';
import { HttpFile } from '../http/http';

/**
* Complex type representing the permission to roles.
*/
export class ResourceSelector extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(ResourceSelector.attributeTypeMap);
    }
