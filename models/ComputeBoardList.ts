...
import { ComputeBoardListAllOf } from './ComputeBoardListAllOf';
...
*/
export class ComputeBoardList extends MoBaseResponse {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<ComputeBoard>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(ComputeBoardList.attributeTypeMap);
    }
