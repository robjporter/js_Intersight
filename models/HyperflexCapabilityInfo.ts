...
import { HyperflexCapabilityInfoAllOf } from './HyperflexCapabilityInfoAllOf';
...
*/
export class HyperflexCapabilityInfo extends MoBaseMo {
    'capabilityConstraints'?: Array<HclConstraint>;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            ...
            "baseName": "CapabilityConstraints",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(HyperflexCapabilityInfo.attributeTypeMap);
    }
