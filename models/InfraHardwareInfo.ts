...
import { InfraHardwareInfoAllOf } from './InfraHardwareInfoAllOf';
...
*/
export class InfraHardwareInfo extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(InfraHardwareInfo.attributeTypeMap);
    }
