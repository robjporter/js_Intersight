...
import { InventoryBaseAllOf } from './InventoryBaseAllOf';
...
*/
export class InventoryBase extends MoBaseMo {
    'deviceMoId'?: string;
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(InventoryBase.attributeTypeMap);
    }
