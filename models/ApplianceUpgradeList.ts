...
import { ApplianceUpgrade } from './ApplianceUpgrade';
import { ApplianceUpgradeListAllOf } from './ApplianceUpgradeListAllOf';
...
*/
export class ApplianceUpgradeList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<ApplianceUpgrade>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<ApplianceUpgrade>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(ApplianceUpgradeList.attributeTypeMap);
    }
