...
import { VirtualizationMemoryCapacityAllOf } from './VirtualizationMemoryCapacityAllOf';
import { HttpFile } from '../http/http';

/**
* Measure of memory allocated and used.
*/
export class VirtualizationMemoryCapacity extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(VirtualizationMemoryCapacity.attributeTypeMap);
    }
