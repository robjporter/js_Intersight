...
import { WorkflowCustomDataPropertyAllOf } from './WorkflowCustomDataPropertyAllOf';
import { HttpFile } from '../http/http';

/**
* Capture all the properties for Custom data type.
*/
export class WorkflowCustomDataProperty extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "customDataTypeId",
            "baseName": "CustomDataTypeId",
            "type": "string",
            "format": ""
        },
        {
            "name": "customDataTypeName",
            "baseName": "CustomDataTypeName",
            "type": "string",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(WorkflowCustomDataProperty.attributeTypeMap);
    }
