...
import { StorageEnclosureListAllOf } from './StorageEnclosureListAllOf';
...
*/
export class StorageEnclosureList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<StorageEnclosure>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<StorageEnclosure>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(StorageEnclosureList.attributeTypeMap);
    }
