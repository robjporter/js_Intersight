...
import { WorkflowWorkerTaskAllOf } from './WorkflowWorkerTaskAllOf';
import { HttpFile } from '../http/http';

/**
* A WorkerTask is a simple task and the smallest granularity of work that can be defined as a task.
*/
export class WorkflowWorkerTask extends WorkflowAbstractWorkerTask {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "catalogMoid",
            "baseName": "CatalogMoid",
            "type": "string",
            "format": ""
        },
        {
            "name": "taskDefinitionId",
            "baseName": "TaskDefinitionId",
            "type": "string",
            "format": ""
        },
        {
            "name": "taskDefinitionName",
            "baseName": "TaskDefinitionName",
            "type": "string",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(WorkflowWorkerTask.attributeTypeMap);
    }
