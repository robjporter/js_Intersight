...
import { CondHclStatusJobAllOf } from './CondHclStatusJobAllOf';
...
*/
export class CondHclStatusJob extends MoBaseMo {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(CondHclStatusJob.attributeTypeMap);
    }
