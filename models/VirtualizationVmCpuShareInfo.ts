...
import { VirtualizationVmCpuShareInfoAllOf } from './VirtualizationVmCpuShareInfoAllOf';
import { HttpFile } from '../http/http';

/**
* Information about the virtual machine's CPU sharing and limits.
*/
export class VirtualizationVmCpuShareInfo extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "cpuOverheadLimit",
            "baseName": "CpuOverheadLimit",
            "type": "number",
            "format": "int64"
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(VirtualizationVmCpuShareInfo.attributeTypeMap);
    }
