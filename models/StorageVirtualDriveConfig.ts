...
import { StorageVirtualDriveConfigAllOf } from './StorageVirtualDriveConfigAllOf';
import { HttpFile } from '../http/http';

/**
* This type models a single virtual drive that needs to be created through this policy.
*/
export class StorageVirtualDriveConfig extends MoBaseComplexType {
    /**
    * Access policy that host has on this virtual drive.
    */
    'accessPolicy'?: StorageVirtualDriveConfigAccessPolicyEnum;
    /**
    ...
    */
    'driveCache'?: StorageVirtualDriveConfigDriveCacheEnum;
    /**
    ...
    */
    'ioPolicy'?: StorageVirtualDriveConfigIoPolicyEnum;
    /**
    ...
    */
    'readPolicy'?: StorageVirtualDriveConfigReadPolicyEnum;
    /**
    ...
    */
    'writePolicy'?: StorageVirtualDriveConfigWritePolicyEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            ...
            "type": "StorageVirtualDriveConfigAccessPolicyEnum",
            "format": ""
        },
        {
            "name": "bootDrive",
        ...
        },
        {
            "name": "driveCache",
            "baseName": "DriveCache",
            "type": "StorageVirtualDriveConfigDriveCacheEnum",
            "format": ""
        },
        {
        ...
        },
        {
            "name": "ioPolicy",
            "baseName": "IoPolicy",
            "type": "StorageVirtualDriveConfigIoPolicyEnum",
            "format": ""
        },
        {
            "name": "name",
        ...
        },
        {
            "name": "readPolicy",
            "baseName": "ReadPolicy",
            "type": "StorageVirtualDriveConfigReadPolicyEnum",
            "format": ""
        },
        {
            "name": "size",
        ...
        },
        {
            ...
            "type": "StorageVirtualDriveConfigWritePolicyEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(StorageVirtualDriveConfig.attributeTypeMap);
    }
...
export type StorageVirtualDriveConfigAccessPolicyEnum = "Default" | "ReadWrite" | "ReadOnly" | "Blocked" ;
export type StorageVirtualDriveConfigDriveCacheEnum = "Default" | "NoChange" | "Enable" | "Disable" ;
export type StorageVirtualDriveConfigIoPolicyEnum = "Default" | "Direct" | "Cached" ;
export type StorageVirtualDriveConfigReadPolicyEnum = "Default" | "ReadAhead" | "NoReadAhead" ;
export type StorageVirtualDriveConfigWritePolicyEnum = "Default" | "WriteThrough" | "WriteBackGoodBbu" | "AlwaysWriteBack" ;
