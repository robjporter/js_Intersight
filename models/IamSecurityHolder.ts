...
import { IamResourcePermissionRelationship } from './IamResourcePermissionRelationship';
import { IamSecurityHolderAllOf } from './IamSecurityHolderAllOf';
...
*/
export class IamSecurityHolder extends MoBaseMo {
    'account'?: IamAccountRelationship;
    /**
    * An array of relationships to iamResourcePermission resources.
    */
    'resourcePermissions'?: Array<IamResourcePermissionRelationship>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "baseName": "ResourcePermissions",
            "type": "Array<IamResourcePermissionRelationship>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(IamSecurityHolder.attributeTypeMap);
    }
