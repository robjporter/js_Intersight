...
import { OsOsSupportAllOf } from './OsOsSupportAllOf';
import { HttpFile } from '../http/http';

/**
* OsSupport is used to validate the support for an Operating System's version.
*/
export class OsOsSupport extends MoBaseMo {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(OsOsSupport.attributeTypeMap);
    }
