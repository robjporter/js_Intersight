...
import { NiaapiReleaseRecommendAllOf } from './NiaapiReleaseRecommendAllOf';
import { HttpFile } from '../http/http';

/**
* This contains the recommend version based on the hardware.
*/
export class NiaapiReleaseRecommend extends MoBaseMo {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(NiaapiReleaseRecommend.attributeTypeMap);
    }
