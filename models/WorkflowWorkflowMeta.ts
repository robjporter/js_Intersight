...
import { WorkflowWorkflowMetaAllOf } from './WorkflowWorkflowMetaAllOf';
import { HttpFile } from '../http/http';

/**
* Contains a workflow definition which is a sequence of tasks to execute.
*/
export class WorkflowWorkflowMeta extends MoBaseMo {
    /**
    ...
    */
    'type'?: WorkflowWorkflowMetaTypeEnum;
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(WorkflowWorkflowMeta.attributeTypeMap);
    }
...
export type WorkflowWorkflowMetaTypeEnum = "SystemDefined" | "UserDefined" | "Dynamic" ;
