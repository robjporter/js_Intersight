...
import { CondHclStatusJob } from './CondHclStatusJob';
import { CondHclStatusJobListAllOf } from './CondHclStatusJobListAllOf';
...
*/
export class CondHclStatusJobList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<CondHclStatusJob>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<CondHclStatusJob>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(CondHclStatusJobList.attributeTypeMap);
    }
