...
import { WorkflowSubWorkflowTaskAllOf } from './WorkflowSubWorkflowTaskAllOf';
import { HttpFile } from '../http/http';

/**
* A SubWorkflowTask is used to include another workflow as a task within this workflow.
*/
export class WorkflowSubWorkflowTask extends WorkflowAbstractWorkerTask {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(WorkflowSubWorkflowTask.attributeTypeMap);
    }
