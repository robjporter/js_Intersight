...
import { WorkflowExpectPromptAllOf } from './WorkflowExpectPromptAllOf';
import { HttpFile } from '../http/http';

/**
* This models a single expect and answer prompt of the interactive command.
*/
export class WorkflowExpectPrompt extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(WorkflowExpectPrompt.attributeTypeMap);
    }
