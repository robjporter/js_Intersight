...
import { VnicRoceSettingsAllOf } from './VnicRoceSettingsAllOf';
import { HttpFile } from '../http/http';

/**
* Settings for RDMA over Converged Ethernet.
*/
export class VnicRoceSettings extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(VnicRoceSettings.attributeTypeMap);
    }
