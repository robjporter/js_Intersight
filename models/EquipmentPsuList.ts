...
import { EquipmentPsuListAllOf } from './EquipmentPsuListAllOf';
...
*/
export class EquipmentPsuList extends MoBaseResponse {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<EquipmentPsu>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(EquipmentPsuList.attributeTypeMap);
    }
