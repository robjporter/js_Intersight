...
import { EquipmentSystemIoController } from './EquipmentSystemIoController';
import { EquipmentSystemIoControllerListAllOf } from './EquipmentSystemIoControllerListAllOf';
...
*/
export class EquipmentSystemIoControllerList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<EquipmentSystemIoController>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<EquipmentSystemIoController>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(EquipmentSystemIoControllerList.attributeTypeMap);
    }
