...
import { NiatelemetryNiaInventoryRelationship } from './NiatelemetryNiaInventoryRelationship';
import { NiatelemetryNiaLicenseStateAllOf } from './NiatelemetryNiaLicenseStateAllOf';
import { HttpFile } from '../http/http';

/**
* Object available at device scope for license information. This determines the usage of this attribute.
*/
export class NiatelemetryNiaLicenseState extends MoBaseMo {
    /**
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            ...
            "baseName": "FeatureActivated",
            "type": "string",
            "format": ""
        },
        {
            "name": "licenseActivated",
            "baseName": "LicenseActivated",
            "type": "string",
            "format": ""
        },
        {
        ...
        },
        {
            "name": "device",
            "baseName": "Device",
            "type": "NiatelemetryNiaInventoryRelationship",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(NiatelemetryNiaLicenseState.attributeTypeMap);
    }
