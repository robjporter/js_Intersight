...
import { StorageVirtualDriveExtension } from './StorageVirtualDriveExtension';
import { StorageVirtualDriveExtensionListAllOf } from './StorageVirtualDriveExtensionListAllOf';
...
*/
export class StorageVirtualDriveExtensionList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<StorageVirtualDriveExtension>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<StorageVirtualDriveExtension>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(StorageVirtualDriveExtensionList.attributeTypeMap);
    }
