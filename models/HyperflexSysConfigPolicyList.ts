...
import { HyperflexSysConfigPolicyListAllOf } from './HyperflexSysConfigPolicyListAllOf';
...
*/
export class HyperflexSysConfigPolicyList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<HyperflexSysConfigPolicy>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<HyperflexSysConfigPolicy>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(HyperflexSysConfigPolicyList.attributeTypeMap);
    }
