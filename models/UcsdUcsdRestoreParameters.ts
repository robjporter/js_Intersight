...
import { UcsdUcsdRestoreParametersAllOf } from './UcsdUcsdRestoreParametersAllOf';
import { HttpFile } from '../http/http';

/**
* Restore Configuration Parameters for UCS Director restore workflow.
*/
export class UcsdUcsdRestoreParameters extends RecoveryConfigParams {
    /**
    ...
    */
    'restoreConfigurationFiles'?: boolean;
    /**
    * Decides whether license should also be restored.
    */
    'restoreLicense'?: boolean;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "restoreConfigurationFiles",
            "baseName": "RestoreConfigurationFiles",
            "type": "boolean",
            "format": ""
        },
        {
            "name": "restoreLicense",
            "baseName": "RestoreLicense",
            "type": "boolean",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(UcsdUcsdRestoreParameters.attributeTypeMap);
    }
