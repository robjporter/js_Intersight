...
import { StoragePureControllerAllOf } from './StoragePureControllerAllOf';
import { HttpFile } from '../http/http';

/**
* A storage controller entity in Pure FlashArray.
*/
export class StoragePureController extends StorageArrayController {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(StoragePureController.attributeTypeMap);
    }
