    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            ...
            "baseName": "ConnectorAttribute",
            "type": "string",
            "format": ""
        },
        {
            "name": "constraintAttributes",
            "baseName": "ConstraintAttributes",
            "type": "Array<string>",
            "format": ""
        },
        {
            "name": "displayAttributes",
            "baseName": "DisplayAttributes",
            "type": "Array<string>",
            "format": ""
        },
        {
        ...
        },
        {
            ...
            "baseName": "SupportedObjects",
            "type": "Array<string>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(WorkflowTargetProperty.attributeTypeMap);
    }
