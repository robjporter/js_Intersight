...
import { VnicVsanSettingsAllOf } from './VnicVsanSettingsAllOf';
import { HttpFile } from '../http/http';

/**
* VSAN configuration for the virtual interface.
*/
export class VnicVsanSettings extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(VnicVsanSettings.attributeTypeMap);
    }
