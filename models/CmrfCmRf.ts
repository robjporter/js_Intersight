...
import { CmrfCmRfAllOf } from './CmrfCmRfAllOf';
...
*/
export class CmrfCmRf extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(CmrfCmRf.attributeTypeMap);
    }
