...
import { WorkflowValidationErrorAllOf } from './WorkflowValidationErrorAllOf';
import { HttpFile } from '../http/http';

/**
* Used to show validation errors for the workflow or for the task within the workflow.
*/
export class WorkflowValidationError extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "transitionName",
            "baseName": "TransitionName",
            "type": "string",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(WorkflowValidationError.attributeTypeMap);
    }
