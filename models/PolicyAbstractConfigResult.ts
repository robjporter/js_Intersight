...
import { PolicyAbstractConfigResultAllOf } from './PolicyAbstractConfigResultAllOf';
import { HttpFile } from '../http/http';

/**
* The results with the overall state and detailed result messages.
*/
export class PolicyAbstractConfigResult extends MoBaseMo {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(PolicyAbstractConfigResult.attributeTypeMap);
    }
