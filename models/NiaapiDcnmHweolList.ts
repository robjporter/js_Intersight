...
import { NiaapiDcnmHweol } from './NiaapiDcnmHweol';
import { NiaapiDcnmHweolListAllOf } from './NiaapiDcnmHweolListAllOf';
...
*/
export class NiaapiDcnmHweolList extends MoBaseResponse {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<NiaapiDcnmHweol>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(NiaapiDcnmHweolList.attributeTypeMap);
    }
