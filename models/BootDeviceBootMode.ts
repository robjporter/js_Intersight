...
import { BootDeviceBootModeAllOf } from './BootDeviceBootModeAllOf';
...
*/
export class BootDeviceBootMode extends InventoryBase {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BootDeviceBootMode.attributeTypeMap);
    }
