...
import { PkixEcdsaKeySpecAllOf } from './PkixEcdsaKeySpecAllOf';
...
*/
export class PkixEcdsaKeySpec extends PkixKeyGenerationSpec {
    /**
    * A specific set of Elliptic Curve parameters, as recommended by NIST in FIPS 186-4.
    */
    'curve'?: PkixEcdsaKeySpecCurveEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "curve",
            "baseName": "Curve",
            "type": "PkixEcdsaKeySpecCurveEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(PkixEcdsaKeySpec.attributeTypeMap);
    }
...
export type PkixEcdsaKeySpecCurveEnum = "P256" | "P224" | "P384" | "P521" ;
