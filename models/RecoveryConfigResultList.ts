...
import { RecoveryConfigResultListAllOf } from './RecoveryConfigResultListAllOf';
...
*/
export class RecoveryConfigResultList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<RecoveryConfigResult>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<RecoveryConfigResult>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(RecoveryConfigResultList.attributeTypeMap);
    }
