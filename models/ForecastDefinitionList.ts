...
import { ForecastDefinitionListAllOf } from './ForecastDefinitionListAllOf';
...
*/
export class ForecastDefinitionList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<ForecastDefinition>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<ForecastDefinition>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(ForecastDefinitionList.attributeTypeMap);
    }
