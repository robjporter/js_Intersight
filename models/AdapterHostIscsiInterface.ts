...
import { AdapterHostIscsiInterfaceAllOf } from './AdapterHostIscsiInterfaceAllOf';
...
*/
export class AdapterHostIscsiInterface extends EquipmentBase {
    'adminState'?: string;
    'epDn'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "hostIscsiInterfaceId",
            "baseName": "HostIscsiInterfaceId",
            "type": "number",
            "format": "int64"
        },
        {
            "name": "hostVisible",
            "baseName": "HostVisible",
            "type": "string",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(AdapterHostIscsiInterface.attributeTypeMap);
    }
