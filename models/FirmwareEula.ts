...
import { FirmwareEulaAllOf } from './FirmwareEulaAllOf';
...
*/
export class FirmwareEula extends MoBaseMo {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(FirmwareEula.attributeTypeMap);
    }
