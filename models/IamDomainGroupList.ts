...
import { IamDomainGroup } from './IamDomainGroup';
import { IamDomainGroupListAllOf } from './IamDomainGroupListAllOf';
...
*/
export class IamDomainGroupList extends MoBaseResponse {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<IamDomainGroup>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(IamDomainGroupList.attributeTypeMap);
    }
