...
import { FirmwareNfsServerAllOf } from './FirmwareNfsServerAllOf';
...
*/
export class FirmwareNfsServer extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(FirmwareNfsServer.attributeTypeMap);
    }
