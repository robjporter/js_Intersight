...
import { WorkflowTaskDefinitionAllOf } from './WorkflowTaskDefinitionAllOf';
...
*/
export class WorkflowTaskDefinition extends MoBaseMo {
    /**
    ...
    */
    'licenseEntitlement'?: WorkflowTaskDefinitionLicenseEntitlementEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "WorkflowTaskDefinitionLicenseEntitlementEnum",
            "format": ""
        },
        {
            "name": "name",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(WorkflowTaskDefinition.attributeTypeMap);
    }
...
export type WorkflowTaskDefinitionLicenseEntitlementEnum = "Base" | "Essential" | "Standard" | "Advantage" | "Premier" ;
