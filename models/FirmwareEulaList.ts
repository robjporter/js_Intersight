...
import { FirmwareEula } from './FirmwareEula';
import { FirmwareEulaListAllOf } from './FirmwareEulaListAllOf';
...
*/
export class FirmwareEulaList extends MoBaseResponse {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<FirmwareEula>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(FirmwareEulaList.attributeTypeMap);
    }
