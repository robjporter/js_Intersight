...
import { NiaapiApicReleaseRecommend } from './NiaapiApicReleaseRecommend';
import { NiaapiApicReleaseRecommendListAllOf } from './NiaapiApicReleaseRecommendListAllOf';
...
*/
export class NiaapiApicReleaseRecommendList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<NiaapiApicReleaseRecommend>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<NiaapiApicReleaseRecommend>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(NiaapiApicReleaseRecommendList.attributeTypeMap);
    }
