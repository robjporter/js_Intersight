...
import { IamPrivateKeySpecListAllOf } from './IamPrivateKeySpecListAllOf';
...
*/
export class IamPrivateKeySpecList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<IamPrivateKeySpec>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<IamPrivateKeySpec>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(IamPrivateKeySpecList.attributeTypeMap);
    }
