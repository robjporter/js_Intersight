...
import { IaasMostRunTasksAllOf } from './IaasMostRunTasksAllOf';
...
*/
export class IaasMostRunTasks extends MoBaseMo {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "taskExecutionCount",
            "baseName": "TaskExecutionCount",
            "type": "number",
            "format": "int64"
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(IaasMostRunTasks.attributeTypeMap);
    }
