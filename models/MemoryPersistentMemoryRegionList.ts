...
import { MemoryPersistentMemoryRegionListAllOf } from './MemoryPersistentMemoryRegionListAllOf';
...
*/
export class MemoryPersistentMemoryRegionList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<MemoryPersistentMemoryRegion>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<MemoryPersistentMemoryRegion>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(MemoryPersistentMemoryRegionList.attributeTypeMap);
    }
