...
import { StorageSasPortAllOf } from './StorageSasPortAllOf';
import { HttpFile } from '../http/http';

/**
* Sas Port details of the SAS endpoint.
*/
export class StorageSasPort extends InventoryBase {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(StorageSasPort.attributeTypeMap);
    }
