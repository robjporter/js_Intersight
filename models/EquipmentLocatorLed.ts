...
import { EquipmentLocatorLedAllOf } from './EquipmentLocatorLedAllOf';
...
*/
export class EquipmentLocatorLed extends InventoryBase {
    'color'?: string;
    'operState'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(EquipmentLocatorLed.attributeTypeMap);
    }
