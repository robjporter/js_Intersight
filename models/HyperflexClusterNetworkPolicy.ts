...
import { HyperflexClusterNetworkPolicyAllOf } from './HyperflexClusterNetworkPolicyAllOf';
...
import { HyperflexMacAddrPrefixRange } from './HyperflexMacAddrPrefixRange';
...
*/
export class HyperflexClusterNetworkPolicy extends PolicyAbstractPolicy {
    /**
    * Enable or disable jumbo frames.
    */
    'jumboFrame'?: boolean;
    'kvmIpRange'?: HyperflexIpAddrRange;
    'macPrefixRange'?: HyperflexMacAddrPrefixRange;
    'mgmtVlan'?: HyperflexNamedVlan;
    /**
    ...
    */
    'uplinkSpeed'?: HyperflexClusterNetworkPolicyUplinkSpeedEnum;
    'vmMigrationVlan'?: HyperflexNamedVlan;
    'vmNetworkVlans'?: Array<HyperflexNamedVlan>;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "uplinkSpeed",
            "baseName": "UplinkSpeed",
            "type": "HyperflexClusterNetworkPolicyUplinkSpeedEnum",
            "format": ""
        },
        {
            "name": "vmMigrationVlan",
            "baseName": "VmMigrationVlan",
            "type": "HyperflexNamedVlan",
            "format": ""
        },
        {
            "name": "vmNetworkVlans",
            "baseName": "VmNetworkVlans",
            "type": "Array<HyperflexNamedVlan>",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(HyperflexClusterNetworkPolicy.attributeTypeMap);
    }
...
export type HyperflexClusterNetworkPolicyUplinkSpeedEnum = "default" | "1G" | "10G" ;
