...
import { RecoveryBackupSchedule } from './RecoveryBackupSchedule';
import { RecoveryScheduleConfigPolicyAllOf } from './RecoveryScheduleConfigPolicyAllOf';
import { HttpFile } from '../http/http';

/**
* Base Schedule config which contains all the required inputs to do schedule on a local or remote server.
*/
export class RecoveryScheduleConfigPolicy extends PolicyAbstractPolicy {
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(RecoveryScheduleConfigPolicy.attributeTypeMap);
    }
