...
import { IamAccountExperience } from './IamAccountExperience';
import { IamAccountExperienceListAllOf } from './IamAccountExperienceListAllOf';
...
*/
export class IamAccountExperienceList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<IamAccountExperience>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<IamAccountExperience>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(IamAccountExperienceList.attributeTypeMap);
    }
