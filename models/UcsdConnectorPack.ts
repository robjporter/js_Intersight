...
import { UcsdConnectorPackAllOf } from './UcsdConnectorPackAllOf';
import { HttpFile } from '../http/http';

/**
* Information about the connector packs present in the backup file.
*/
export class UcsdConnectorPack extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(UcsdConnectorPack.attributeTypeMap);
    }
