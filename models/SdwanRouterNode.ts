...
import { SdwanRouterNodeAllOf } from './SdwanRouterNodeAllOf';
...
*/
export class SdwanRouterNode extends MoBaseMo {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(SdwanRouterNode.attributeTypeMap);
    }
