...
import { WorkflowConstraintsAllOf } from './WorkflowConstraintsAllOf';
import { WorkflowEnumEntry } from './WorkflowEnumEntry';
import { HttpFile } from '../http/http';

/**
* Captures the constraints for valid parameter values.
*/
export class WorkflowConstraints extends MoBaseComplexType {
    'enumList'?: Array<WorkflowEnumEntry>;
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(WorkflowConstraints.attributeTypeMap);
    }
