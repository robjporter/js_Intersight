...
import { IamAccountAllOf } from './IamAccountAllOf';
...
*/
export class IamAccount extends MoBaseMo {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(IamAccount.attributeTypeMap);
    }
