...
*/
export class HclProductAllOf {
    'driverNames'?: Array<string>;
    /**
    * Error code indicating the support status.
    */
    'errorCode'?: HclProductAllOfErrorCodeEnum;
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "errorCode",
            "baseName": "ErrorCode",
            "type": "HclProductAllOfErrorCodeEnum",
            "format": ""
        },
        {
            "name": "firmwares",
    ...
    static getAttributeTypeMap() {
        return HclProductAllOf.attributeTypeMap;
    }
