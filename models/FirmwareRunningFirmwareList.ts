...
import { FirmwareRunningFirmwareListAllOf } from './FirmwareRunningFirmwareListAllOf';
...
*/
export class FirmwareRunningFirmwareList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<FirmwareRunningFirmware>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<FirmwareRunningFirmware>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(FirmwareRunningFirmwareList.attributeTypeMap);
    }
