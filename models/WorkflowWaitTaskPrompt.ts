...
import { WorkflowWaitTaskPromptAllOf } from './WorkflowWaitTaskPromptAllOf';
...
*/
export class WorkflowWaitTaskPrompt extends MoBaseComplexType {
    /**
    ...
    */
    'taskStatus'?: WorkflowWaitTaskPromptTaskStatusEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "taskStatus",
            "baseName": "TaskStatus",
            "type": "WorkflowWaitTaskPromptTaskStatusEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(WorkflowWaitTaskPrompt.attributeTypeMap);
    }
...
export type WorkflowWaitTaskPromptTaskStatusEnum = "Scheduled" | "InProgress" | "NoOp" | "Timeout" | "Completed" | "Failed" ;
