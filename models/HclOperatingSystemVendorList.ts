...
import { HclOperatingSystemVendor } from './HclOperatingSystemVendor';
import { HclOperatingSystemVendorListAllOf } from './HclOperatingSystemVendorListAllOf';
...
*/
export class HclOperatingSystemVendorList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<HclOperatingSystemVendor>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<HclOperatingSystemVendor>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(HclOperatingSystemVendorList.attributeTypeMap);
    }
