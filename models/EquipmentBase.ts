...
import { EquipmentBaseAllOf } from './EquipmentBaseAllOf';
...
*/
export class EquipmentBase extends InventoryBase {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(EquipmentBase.attributeTypeMap);
    }
