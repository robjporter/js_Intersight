...
import { ManagementInterfaceListAllOf } from './ManagementInterfaceListAllOf';
...
*/
export class ManagementInterfaceList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<ManagementInterface>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<ManagementInterface>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(ManagementInterfaceList.attributeTypeMap);
    }
