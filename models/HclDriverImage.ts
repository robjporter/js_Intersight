...
import { HclDriverImageAllOf } from './HclDriverImageAllOf';
...
*/
export class HclDriverImage extends MoBaseMo {
    /**
    ...
    */
    'managementType'?: HclDriverImageManagementTypeEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "HclDriverImageManagementTypeEnum",
            "format": ""
        },
        {
            "name": "serverPid",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(HclDriverImage.attributeTypeMap);
    }
...
export type HclDriverImageManagementTypeEnum = "UCSM" | "IMC" ;
