...
import { PortPhysicalAllOf } from './PortPhysicalAllOf';
import { HttpFile } from '../http/http';

/**
* Abstract super class for all ports.
*/
export class PortPhysical extends InventoryBase {
    'operState'?: string;
    'role'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(PortPhysical.attributeTypeMap);
    }
