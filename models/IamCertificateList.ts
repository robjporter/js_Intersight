...
import { IamCertificateListAllOf } from './IamCertificateListAllOf';
...
*/
export class IamCertificateList extends MoBaseResponse {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<IamCertificate>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(IamCertificateList.attributeTypeMap);
    }
