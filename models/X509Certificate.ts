...
import { X509CertificateAllOf } from './X509CertificateAllOf';
import { HttpFile } from '../http/http';

/**
* The representation of an X.509 certificate.
*/
export class X509Certificate extends MoBaseComplexType {
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(X509Certificate.attributeTypeMap);
    }
