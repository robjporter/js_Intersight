...
import { NiatelemetryDiskinfoAllOf } from './NiatelemetryDiskinfoAllOf';
import { HttpFile } from '../http/http';

/**
* Object that carries all the fields needed for Disk usage. This determines the usage of disk capacity of a device.
*/
export class NiatelemetryDiskinfo extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(NiatelemetryDiskinfo.attributeTypeMap);
    }
