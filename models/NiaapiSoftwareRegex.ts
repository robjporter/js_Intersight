...
import { NiaapiSoftwareRegexAllOf } from './NiaapiSoftwareRegexAllOf';
import { HttpFile } from '../http/http';

/**
* The regular expression to parse the software version strings.
*/
export class NiaapiSoftwareRegex extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(NiaapiSoftwareRegex.attributeTypeMap);
    }
