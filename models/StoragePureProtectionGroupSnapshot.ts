...
import { StoragePureProtectionGroupSnapshotAllOf } from './StoragePureProtectionGroupSnapshotAllOf';
import { HttpFile } from '../http/http';

/**
* Protection group snapshot entity in Pure protection group.
*/
export class StoragePureProtectionGroupSnapshot extends StorageProtectionGroupSnapshot {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(StoragePureProtectionGroupSnapshot.attributeTypeMap);
    }
