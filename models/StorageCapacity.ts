...
export class StorageCapacity extends MoBaseComplexType {
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(StorageCapacity.attributeTypeMap);
    }
