...
import { IaasUcsdManagedInfraListAllOf } from './IaasUcsdManagedInfraListAllOf';
...
*/
export class IaasUcsdManagedInfraList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<IaasUcsdManagedInfra>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<IaasUcsdManagedInfra>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(IaasUcsdManagedInfraList.attributeTypeMap);
    }
