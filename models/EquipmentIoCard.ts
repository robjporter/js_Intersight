...
import { EquipmentIoCardAllOf } from './EquipmentIoCardAllOf';
...
*/
export class EquipmentIoCard extends EquipmentBase {
    'operState'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(EquipmentIoCard.attributeTypeMap);
    }
