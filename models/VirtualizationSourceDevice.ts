...
import { VirtualizationSourceDeviceAllOf } from './VirtualizationSourceDeviceAllOf';
...
*/
export class VirtualizationSourceDevice extends MoBaseMo {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(VirtualizationSourceDevice.attributeTypeMap);
    }
