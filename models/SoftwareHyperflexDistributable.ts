...
import { SoftwareHyperflexDistributableAllOf } from './SoftwareHyperflexDistributableAllOf';
...
*/
export class SoftwareHyperflexDistributable extends FirmwareBaseDistributable {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(SoftwareHyperflexDistributable.attributeTypeMap);
    }
