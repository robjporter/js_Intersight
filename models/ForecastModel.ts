...
import { ForecastModelAllOf } from './ForecastModelAllOf';
...
*/
export class ForecastModel extends MoBaseComplexType {
    /**
    ...
    */
    'modelType'?: ForecastModelModelTypeEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "modelType",
            "baseName": "ModelType",
            "type": "ForecastModelModelTypeEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(ForecastModel.attributeTypeMap);
    }
...
export type ForecastModelModelTypeEnum = "Linear" ;
