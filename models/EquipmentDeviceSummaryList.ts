...
import { EquipmentDeviceSummary } from './EquipmentDeviceSummary';
import { EquipmentDeviceSummaryListAllOf } from './EquipmentDeviceSummaryListAllOf';
...
*/
export class EquipmentDeviceSummaryList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<EquipmentDeviceSummary>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<EquipmentDeviceSummary>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(EquipmentDeviceSummaryList.attributeTypeMap);
    }
