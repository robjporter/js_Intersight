...
import { SoftwareHclMetaAllOf } from './SoftwareHclMetaAllOf';
...
*/
export class SoftwareHclMeta extends FirmwareBaseDistributable {
    /**
    * The type of content that the Json file holds (Incremental or full dump).
    */
    'contentType'?: SoftwareHclMetaContentTypeEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            ...
            "type": "SoftwareHclMetaContentTypeEnum",
            "format": ""
        },
        {
            "name": "catalog",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(SoftwareHclMeta.attributeTypeMap);
    }
...
export type SoftwareHclMetaContentTypeEnum = "Full" | "Incremental" ;
