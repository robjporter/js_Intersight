...
import { VnicPlacementSettingsAllOf } from './VnicPlacementSettingsAllOf';
import { HttpFile } from '../http/http';

/**
* Placement Settings for the virtual interface.
*/
export class VnicPlacementSettings extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(VnicPlacementSettings.attributeTypeMap);
    }
