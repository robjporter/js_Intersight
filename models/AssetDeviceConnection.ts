...
import { AssetDeviceConnectionAllOf } from './AssetDeviceConnectionAllOf';
...
*/
export class AssetDeviceConnection extends MoBaseMo {
    /**
    ...
    */
    'connectionStatus'?: AssetDeviceConnectionConnectionStatusEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "AssetDeviceConnectionConnectionStatusEnum",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(AssetDeviceConnection.attributeTypeMap);
    }
...
export type AssetDeviceConnectionConnectionStatusEnum = "" | "Connected" | "NotConnected" | "ClaimInProgress" | "Unclaimed" ;
