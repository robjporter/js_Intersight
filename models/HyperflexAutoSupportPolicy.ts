...
import { HyperflexAutoSupportPolicyAllOf } from './HyperflexAutoSupportPolicyAllOf';
...
*/
export class HyperflexAutoSupportPolicy extends PolicyAbstractPolicy {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "serviceTicketReceipient",
            "baseName": "ServiceTicketReceipient",
            "type": "string",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(HyperflexAutoSupportPolicy.attributeTypeMap);
    }
