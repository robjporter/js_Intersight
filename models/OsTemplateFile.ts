...
import { OsTemplateFileAllOf } from './OsTemplateFileAllOf';
...
*/
export class OsTemplateFile extends MoBaseMo {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "baseName": "TemplateContent",
            "type": "string",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(OsTemplateFile.attributeTypeMap);
    }
