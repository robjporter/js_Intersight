...
import { IamEndPointPasswordProperties } from './IamEndPointPasswordProperties';
import { IamEndPointUserPolicyAllOf } from './IamEndPointUserPolicyAllOf';
import { IamEndPointUserRoleRelationship } from './IamEndPointUserRoleRelationship';
...
*/
export class IamEndPointUserPolicy extends PolicyAbstractPolicy {
    'passwordProperties'?: IamEndPointPasswordProperties;
    /**
    * An array of relationships to iamEndPointUserRole resources.
    */
    'endPointUserRoles'?: Array<IamEndPointUserRoleRelationship>;
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            ...
            "baseName": "PasswordProperties",
            "type": "IamEndPointPasswordProperties",
            "format": ""
        },
        {
            "name": "endPointUserRoles",
            "baseName": "EndPointUserRoles",
            "type": "Array<IamEndPointUserRoleRelationship>",
            "format": ""
        },
        {
            "name": "organization",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(IamEndPointUserPolicy.attributeTypeMap);
    }
