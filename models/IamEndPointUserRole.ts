...
import { IamEndPointUserPolicyRelationship } from './IamEndPointUserPolicyRelationship';
import { IamEndPointUserRelationship } from './IamEndPointUserRelationship';
import { IamEndPointUserRoleAllOf } from './IamEndPointUserRoleAllOf';
...
*/
export class IamEndPointUserRole extends MoBaseMo {
    /**
    ...
    */
    'endPointRole'?: Array<IamEndPointRoleRelationship>;
    'endPointUser'?: IamEndPointUserRelationship;
    'endPointUserPolicy'?: IamEndPointUserPolicyRelationship;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "endPointRole",
            "baseName": "EndPointRole",
            "type": "Array<IamEndPointRoleRelationship>",
            "format": ""
        },
        {
            "name": "endPointUser",
            "baseName": "EndPointUser",
            "type": "IamEndPointUserRelationship",
            "format": ""
        },
        {
            "name": "endPointUserPolicy",
            "baseName": "EndPointUserPolicy",
            "type": "IamEndPointUserPolicyRelationship",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(IamEndPointUserRole.attributeTypeMap);
    }
