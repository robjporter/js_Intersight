...
import { StoragePureHostListAllOf } from './StoragePureHostListAllOf';
...
*/
export class StoragePureHostList extends MoBaseResponse {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<StoragePureHost>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(StoragePureHostList.attributeTypeMap);
    }
