...
import { HyperflexServerFirmwareVersionListAllOf } from './HyperflexServerFirmwareVersionListAllOf';
...
*/
export class HyperflexServerFirmwareVersionList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<HyperflexServerFirmwareVersion>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<HyperflexServerFirmwareVersion>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(HyperflexServerFirmwareVersionList.attributeTypeMap);
    }
