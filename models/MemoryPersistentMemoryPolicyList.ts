...
import { MemoryPersistentMemoryPolicy } from './MemoryPersistentMemoryPolicy';
import { MemoryPersistentMemoryPolicyListAllOf } from './MemoryPersistentMemoryPolicyListAllOf';
...
*/
export class MemoryPersistentMemoryPolicyList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<MemoryPersistentMemoryPolicy>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<MemoryPersistentMemoryPolicy>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(MemoryPersistentMemoryPolicyList.attributeTypeMap);
    }
