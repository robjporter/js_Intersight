...
import { ComputePhysicalSummaryAllOf } from './ComputePhysicalSummaryAllOf';
...
*/
export class ComputePhysicalSummary extends ViewsView {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(ComputePhysicalSummary.attributeTypeMap);
    }
