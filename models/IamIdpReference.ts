...
import { IamIdpReferenceAllOf } from './IamIdpReferenceAllOf';
...
*/
export class IamIdpReference extends MoBaseMo {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(IamIdpReference.attributeTypeMap);
    }
