...
import { SdcardPartition } from './SdcardPartition';
import { SdcardPolicyAllOf } from './SdcardPolicyAllOf';
import { HttpFile } from '../http/http';

/**
* Policy for configuring SD Card settings on endpoint.
*/
export class SdcardPolicy extends PolicyAbstractPolicy {
    'partitions'?: Array<SdcardPartition>;
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(SdcardPolicy.attributeTypeMap);
    }
