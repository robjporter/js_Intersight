...
export class MoDocumentCount extends MoBaseResponse {
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(MoDocumentCount.attributeTypeMap);
    }
