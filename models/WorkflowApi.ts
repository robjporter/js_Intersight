...
import { WorkflowApiAllOf } from './WorkflowApiAllOf';
...
*/
export class WorkflowApi extends MoBaseComplexType {
    /**
    ...
    */
    'contentType'?: WorkflowApiContentTypeEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "WorkflowApiContentTypeEnum",
            "format": ""
        },
        {
            "name": "name",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(WorkflowApi.attributeTypeMap);
    }
...
export type WorkflowApiContentTypeEnum = "json" | "xml" | "text" ;
