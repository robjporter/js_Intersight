...
import { StoragePhysicalPortAllOf } from './StoragePhysicalPortAllOf';
import { HttpFile } from '../http/http';

/**
* Common attributes for a physical port in a storage array.
*/
export class StoragePhysicalPort extends MoBaseMo {
    /**
    ...
    */
    'status'?: StoragePhysicalPortStatusEnum;
    /**
    * Port type - possible values are FC, FCoE and iSCSI.
    */
    'type'?: StoragePhysicalPortTypeEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "Status",
            "type": "StoragePhysicalPortStatusEnum",
            "format": ""
        },
        {
            "name": "type",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(StoragePhysicalPort.attributeTypeMap);
    }
...
export type StoragePhysicalPortStatusEnum = "Unknown" | "Ok" | "Degraded" | "Critical" | "Offline" | "Identifying" | "NotAvailable" | "Updating" | "Unrecognized" ;
export type StoragePhysicalPortTypeEnum = "FC" | "iSCSI" | "FCoE" ;
