...
import { TamAdvisoryCountAllOf } from './TamAdvisoryCountAllOf';
import { HttpFile } from '../http/http';

/**
* Total number of advisories currently affecting a given Account.
*/
export class TamAdvisoryCount extends MoBaseMo {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(TamAdvisoryCount.attributeTypeMap);
    }
