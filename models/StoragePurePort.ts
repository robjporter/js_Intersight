...
import { StoragePhysicalPort } from './StoragePhysicalPort';
import { StoragePurePortAllOf } from './StoragePurePortAllOf';
import { HttpFile } from '../http/http';

/**
* Port entity in Pure FlashArray.
*/
export class StoragePurePort extends StoragePhysicalPort {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(StoragePurePort.attributeTypeMap);
    }
