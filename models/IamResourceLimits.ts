...
import { IamResourceLimitsAllOf } from './IamResourceLimitsAllOf';
...
*/
export class IamResourceLimits extends MoBaseMo {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "perAccountUserLimit",
            "baseName": "PerAccountUserLimit",
            "type": "number",
            "format": "int64"
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(IamResourceLimits.attributeTypeMap);
    }
