...
import { VirtualizationGuestInfoAllOf } from './VirtualizationGuestInfoAllOf';
import { HttpFile } from '../http/http';

/**
* Captures the common details of the guest personality that runs in a VM.
*/
export class VirtualizationGuestInfo extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(VirtualizationGuestInfo.attributeTypeMap);
    }
