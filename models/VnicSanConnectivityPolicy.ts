...
import { VnicFcIfRelationship } from './VnicFcIfRelationship';
import { VnicSanConnectivityPolicyAllOf } from './VnicSanConnectivityPolicyAllOf';
...
*/
export class VnicSanConnectivityPolicy extends PolicyAbstractPolicy {
    /**
    * An array of relationships to vnicFcIf resources.
    */
    'fcIfs'?: Array<VnicFcIfRelationship>;
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "fcIfs",
            "baseName": "FcIfs",
            "type": "Array<VnicFcIfRelationship>",
            "format": ""
        },
        {
            "name": "organization",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(VnicSanConnectivityPolicy.attributeTypeMap);
    }
