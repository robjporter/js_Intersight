...
import { AssetClusterMemberAllOf } from './AssetClusterMemberAllOf';
...
*/
export class AssetClusterMember extends AssetDeviceConnection {
    /**
    ...
    */
    'leadership'?: AssetClusterMemberLeadershipEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "leadership",
            "baseName": "Leadership",
            "type": "AssetClusterMemberLeadershipEnum",
            "format": ""
        },
        {
            "name": "lockedLeader",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(AssetClusterMember.attributeTypeMap);
    }
...
export type AssetClusterMemberLeadershipEnum = "Unknown" | "Primary" | "Secondary" ;
