...
import { IaasConnectorPackListAllOf } from './IaasConnectorPackListAllOf';
...
*/
export class IaasConnectorPackList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<IaasConnectorPack>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<IaasConnectorPack>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(IaasConnectorPackList.attributeTypeMap);
    }
