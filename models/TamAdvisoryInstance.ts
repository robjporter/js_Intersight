...
import { TamAdvisoryInstanceAllOf } from './TamAdvisoryInstanceAllOf';
...
*/
export class TamAdvisoryInstance extends MoBaseMo {
    /**
    ...
    */
    'state'?: TamAdvisoryInstanceStateEnum;
    'advisory'?: TamAdvisoryRelationship;
    'affectedObject'?: MoBaseMoRelationship;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "affectedObjectMoid",
            "baseName": "AffectedObjectMoid",
            "type": "string",
            "format": ""
        },
        {
        ...
        },
        {
            ...
            "baseName": "LastStateChangeTime",
            "type": "Date",
            "format": "date-time"
        },
        {
            "name": "lastVerifiedTime",
            "baseName": "LastVerifiedTime",
            "type": "Date",
            "format": "date-time"
        },
        {
            "name": "state",
            "baseName": "State",
            "type": "TamAdvisoryInstanceStateEnum",
            "format": ""
        },
        {
            "name": "advisory",
        ...
        },
        {
            ...
            "baseName": "DeviceRegistration",
            "type": "AssetDeviceRegistrationRelationship",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(TamAdvisoryInstance.attributeTypeMap);
    }
...
export type TamAdvisoryInstanceStateEnum = "unknown" | "active" | "cleared" ;
