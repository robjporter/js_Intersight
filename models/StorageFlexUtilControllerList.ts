...
import { StorageFlexUtilControllerListAllOf } from './StorageFlexUtilControllerListAllOf';
...
*/
export class StorageFlexUtilControllerList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<StorageFlexUtilController>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<StorageFlexUtilController>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(StorageFlexUtilControllerList.attributeTypeMap);
    }
