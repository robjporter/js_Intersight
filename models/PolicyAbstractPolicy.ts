...
import { PolicyAbstractPolicyAllOf } from './PolicyAbstractPolicyAllOf';
import { HttpFile } from '../http/http';

/**
* A base abstract class for all configuration policies that can be applied to service profiles.
*/
export class PolicyAbstractPolicy extends MoBaseMo {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(PolicyAbstractPolicy.attributeTypeMap);
    }
