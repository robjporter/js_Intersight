...
export class PortSubGroup extends InventoryBase {
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(PortSubGroup.attributeTypeMap);
    }
