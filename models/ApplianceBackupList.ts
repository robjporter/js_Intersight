...
import { ApplianceBackup } from './ApplianceBackup';
import { ApplianceBackupListAllOf } from './ApplianceBackupListAllOf';
...
*/
export class ApplianceBackupList extends MoBaseResponse {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<ApplianceBackup>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(ApplianceBackupList.attributeTypeMap);
    }
