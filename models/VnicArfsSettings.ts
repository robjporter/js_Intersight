...
export class VnicArfsSettings extends MoBaseComplexType {
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(VnicArfsSettings.attributeTypeMap);
    }
