...
import { NiaapiDetailAllOf } from './NiaapiDetailAllOf';
import { HttpFile } from '../http/http';

/**
* The content inside the metadata package with filename and check sum for this file.
*/
export class NiaapiDetail extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(NiaapiDetail.attributeTypeMap);
    }
