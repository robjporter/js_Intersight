...
import { ResourcePerTypeCombinedSelectorAllOf } from './ResourcePerTypeCombinedSelectorAllOf';
import { HttpFile } from '../http/http';

/**
* Complex type representing an object type to associated filter by combining all selectors.
*/
export class ResourcePerTypeCombinedSelector extends MoBaseComplexType {
    /**
    ...
    */
    'selectorObjectType'?: string;

    static readonly discriminator: string | undefined = undefined;

    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "combinedSelector",
            "baseName": "CombinedSelector",
            "type": "string",
            "format": ""
        },
        {
            "name": "emptyFilter",
            "baseName": "EmptyFilter",
            "type": "boolean",
            "format": ""
        },
        {
            "name": "selectorObjectType",
            "baseName": "SelectorObjectType",
            "type": "string",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(ResourcePerTypeCombinedSelector.attributeTypeMap);
    }
