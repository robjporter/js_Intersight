...
import { AssetConnectionControlMessage } from './AssetConnectionControlMessage';
import { AssetDeviceClaimAllOf } from './AssetDeviceClaimAllOf';
...
*/
export class AssetDeviceClaim extends MoBaseMo {
    'deviceUpdates'?: Array<AssetConnectionControlMessage>;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "deviceUpdates",
            "baseName": "DeviceUpdates",
            "type": "Array<AssetConnectionControlMessage>",
            "format": ""
        },
        {
            "name": "securityToken",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(AssetDeviceClaim.attributeTypeMap);
    }
