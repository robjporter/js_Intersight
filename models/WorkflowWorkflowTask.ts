...
import { WorkflowWorkflowTaskAllOf } from './WorkflowWorkflowTaskAllOf';
import { HttpFile } from '../http/http';

/**
* Task instance within the workflow to be executed.
*/
export class WorkflowWorkflowTask extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(WorkflowWorkflowTask.attributeTypeMap);
    }
