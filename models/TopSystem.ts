...
import { TopSystemAllOf } from './TopSystemAllOf';
import { HttpFile } from '../http/http';

/**
* Root container for all UCSM / CIMC MOs.
*/
export class TopSystem extends InventoryBase {
    /**
    ...
    */
    'computeBlades'?: Array<ComputeBladeRelationship>;
    /**
    * An array of relationships to computeRackUnit resources.
    */
    'computeRackUnits'?: Array<ComputeRackUnitRelationship>;
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "computeBlades",
            "baseName": "ComputeBlades",
            "type": "Array<ComputeBladeRelationship>",
            "format": ""
        },
        {
            "name": "computeRackUnits",
            "baseName": "ComputeRackUnits",
            "type": "Array<ComputeRackUnitRelationship>",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(TopSystem.attributeTypeMap);
    }
