...
import { HclConstraintAllOf } from './HclConstraintAllOf';
...
*/
export class HclConstraint extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "baseName": "ConstraintValue",
            "type": "string",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(HclConstraint.attributeTypeMap);
    }
