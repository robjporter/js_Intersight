...
import { ForecastInstanceAllOf } from './ForecastInstanceAllOf';
...
*/
export class ForecastInstance extends MoBaseMo {
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(ForecastInstance.attributeTypeMap);
    }
