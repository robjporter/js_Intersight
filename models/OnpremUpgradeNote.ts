...
import { OnpremUpgradeNoteAllOf } from './OnpremUpgradeNoteAllOf';
import { HttpFile } from '../http/http';

/**
* UpgradeNote managed object contains the description of one feature/bug fix.
*/
export class OnpremUpgradeNote extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(OnpremUpgradeNote.attributeTypeMap);
    }
