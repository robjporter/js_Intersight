...
import { StoragePurePort } from './StoragePurePort';
import { StoragePurePortListAllOf } from './StoragePurePortListAllOf';
...
*/
export class StoragePurePortList extends MoBaseResponse {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<StoragePurePort>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(StoragePurePortList.attributeTypeMap);
    }
