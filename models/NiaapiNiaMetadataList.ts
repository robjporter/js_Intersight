...
import { NiaapiNiaMetadata } from './NiaapiNiaMetadata';
import { NiaapiNiaMetadataListAllOf } from './NiaapiNiaMetadataListAllOf';
...
*/
export class NiaapiNiaMetadataList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<NiaapiNiaMetadata>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<NiaapiNiaMetadata>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(NiaapiNiaMetadataList.attributeTypeMap);
    }
