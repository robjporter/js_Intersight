...
import { MemoryArrayListAllOf } from './MemoryArrayListAllOf';
...
*/
export class MemoryArrayList extends MoBaseResponse {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<MemoryArray>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(MemoryArrayList.attributeTypeMap);
    }
