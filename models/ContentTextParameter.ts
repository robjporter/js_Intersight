...
import { ContentTextParameterAllOf } from './ContentTextParameterAllOf';
import { HttpFile } from '../http/http';

/**
* Concrete implementation of BaseParameter for Text content.
*/
export class ContentTextParameter extends ContentBaseParameter {
    /**
    ...
    */
    'isNextCaptureOnSameLine'?: boolean;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "isDelimiter",
            "baseName": "IsDelimiter",
            "type": "boolean",
            "format": ""
        },
        {
            "name": "isNextCaptureOnSameLine",
            "baseName": "IsNextCaptureOnSameLine",
            "type": "boolean",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(ContentTextParameter.attributeTypeMap);
    }
