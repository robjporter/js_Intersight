...
import { SoftwarerepositoryHttpServerAllOf } from './SoftwarerepositoryHttpServerAllOf';
import { HttpFile } from '../http/http';

/**
* An external HTTP file server. This can represent the cisco.com website or a HTTP server in the user's datacenter.
*/
export class SoftwarerepositoryHttpServer extends SoftwarerepositoryFileServer {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(SoftwarerepositoryHttpServer.attributeTypeMap);
    }
