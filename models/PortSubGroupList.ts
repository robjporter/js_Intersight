...
import { PortSubGroupListAllOf } from './PortSubGroupListAllOf';
...
*/
export class PortSubGroupList extends MoBaseResponse {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<PortSubGroup>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(PortSubGroupList.attributeTypeMap);
    }
