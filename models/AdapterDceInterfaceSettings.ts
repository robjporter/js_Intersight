...
import { AdapterDceInterfaceSettingsAllOf } from './AdapterDceInterfaceSettingsAllOf';
...
*/
export class AdapterDceInterfaceSettings extends MoBaseComplexType {
    /**
    ...
    */
    'fecMode'?: AdapterDceInterfaceSettingsFecModeEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "fecMode",
            "baseName": "FecMode",
            "type": "AdapterDceInterfaceSettingsFecModeEnum",
            "format": ""
        },
        {
            "name": "interfaceId",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(AdapterDceInterfaceSettings.attributeTypeMap);
    }
...
export type AdapterDceInterfaceSettingsFecModeEnum = "Auto" | "cl91" | "cl74" | "Off" ;
