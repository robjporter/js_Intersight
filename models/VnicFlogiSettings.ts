...
import { VnicFlogiSettingsAllOf } from './VnicFlogiSettingsAllOf';
import { HttpFile } from '../http/http';

/**
* Fibre Channel Flogi Settings.
*/
export class VnicFlogiSettings extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(VnicFlogiSettings.attributeTypeMap);
    }
