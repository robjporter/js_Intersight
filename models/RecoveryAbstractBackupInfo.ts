...
import { RecoveryAbstractBackupInfoAllOf } from './RecoveryAbstractBackupInfoAllOf';
import { HttpFile } from '../http/http';

/**
* Abstract class describing a backup. Backup objects for all devices must inherit from this class.
*/
export class RecoveryAbstractBackupInfo extends MoBaseMo {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(RecoveryAbstractBackupInfo.attributeTypeMap);
    }
