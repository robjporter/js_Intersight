...
import { IamPrivilegeAllOf } from './IamPrivilegeAllOf';
...
*/
export class IamPrivilege extends MoBaseMo {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(IamPrivilege.attributeTypeMap);
    }
