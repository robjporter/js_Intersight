...
import { HclFirmware } from './HclFirmware';
import { HclProductAllOf } from './HclProductAllOf';
...
*/
export class HclProduct extends MoBaseComplexType {
    'driverNames'?: Array<string>;
    /**
    * Error code indicating the support status.
    */
    'errorCode'?: HclProductErrorCodeEnum;
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "errorCode",
            "baseName": "ErrorCode",
            "type": "HclProductErrorCodeEnum",
            "format": ""
        },
        {
            "name": "firmwares",
            "baseName": "Firmwares",
            "type": "Array<HclFirmware>",
            "format": ""
        },
        {
            "name": "id",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(HclProduct.attributeTypeMap);
    }
