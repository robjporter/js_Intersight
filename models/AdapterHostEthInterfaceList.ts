...
import { AdapterHostEthInterfaceListAllOf } from './AdapterHostEthInterfaceListAllOf';
...
*/
export class AdapterHostEthInterfaceList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<AdapterHostEthInterface>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<AdapterHostEthInterface>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(AdapterHostEthInterfaceList.attributeTypeMap);
    }
