...
import { VmediaMapping } from './VmediaMapping';
import { VmediaPolicyAllOf } from './VmediaPolicyAllOf';
import { HttpFile } from '../http/http';

/**
* Policy to configure virtual media settings on endpoint.
*/
export class VmediaPolicy extends PolicyAbstractPolicy {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(VmediaPolicy.attributeTypeMap);
    }
