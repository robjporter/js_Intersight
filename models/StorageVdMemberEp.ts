...
import { StorageVdMemberEpAllOf } from './StorageVdMemberEpAllOf';
...
*/
export class StorageVdMemberEp extends InventoryBase {
    ...
    */
    ...
    'storageVirtualDrive'?: StorageVirtualDriveRelationship;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "storageVirtualDrive",
            "baseName": "StorageVirtualDrive",
            "type": "StorageVirtualDriveRelationship",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(StorageVdMemberEp.attributeTypeMap);
    }
