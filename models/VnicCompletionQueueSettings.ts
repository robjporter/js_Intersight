...
import { VnicCompletionQueueSettingsAllOf } from './VnicCompletionQueueSettingsAllOf';
import { HttpFile } from '../http/http';

/**
* Completion Queue resource settings.
*/
export class VnicCompletionQueueSettings extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(VnicCompletionQueueSettings.attributeTypeMap);
    }
