...
import { SshPolicyAllOf } from './SshPolicyAllOf';
import { HttpFile } from '../http/http';

/**
* Secure shell policy on the endpoint.
*/
export class SshPolicy extends PolicyAbstractPolicy {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(SshPolicy.attributeTypeMap);
    }
