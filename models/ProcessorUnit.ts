...
import { ProcessorUnitAllOf } from './ProcessorUnitAllOf';
import { HttpFile } from '../http/http';

/**
* The CPU present on a server.
*/
export class ProcessorUnit extends EquipmentBase {
    'architecture'?: string;
    'numCores'?: number;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "numCoresEnabled",
            "baseName": "NumCoresEnabled",
            "type": "string",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(ProcessorUnit.attributeTypeMap);
    }
