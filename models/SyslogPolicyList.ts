...
import { SyslogPolicy } from './SyslogPolicy';
import { SyslogPolicyListAllOf } from './SyslogPolicyListAllOf';
...
*/
export class SyslogPolicyList extends MoBaseResponse {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<SyslogPolicy>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(SyslogPolicyList.attributeTypeMap);
    }
