...
import { VirtualizationVmMemoryShareInfoAllOf } from './VirtualizationVmMemoryShareInfoAllOf';
import { HttpFile } from '../http/http';

/**
* Information about the virtual machine's memory sharing and limits. For more information, see VMware documentation.
*/
export class VirtualizationVmMemoryShareInfo extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "memOverheadLimit",
            "baseName": "MemOverheadLimit",
            "type": "number",
            "format": "int64"
        },
        {
            "name": "memReservation",
            "baseName": "MemReservation",
            "type": "number",
            "format": "int64"
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(VirtualizationVmMemoryShareInfo.attributeTypeMap);
    }
