...
import { HyperflexClusterNetworkPolicyListAllOf } from './HyperflexClusterNetworkPolicyListAllOf';
...
*/
export class HyperflexClusterNetworkPolicyList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<HyperflexClusterNetworkPolicy>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<HyperflexClusterNetworkPolicy>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(HyperflexClusterNetworkPolicyList.attributeTypeMap);
    }
