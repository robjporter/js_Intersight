...
import { LicenseAccountLicenseDataListAllOf } from './LicenseAccountLicenseDataListAllOf';
...
*/
export class LicenseAccountLicenseDataList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<LicenseAccountLicenseData>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<LicenseAccountLicenseData>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(LicenseAccountLicenseDataList.attributeTypeMap);
    }
