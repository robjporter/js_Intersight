...
import { VirtualizationStorageCapacityAllOf } from './VirtualizationStorageCapacityAllOf';
import { HttpFile } from '../http/http';

/**
* Captures the common attributes of a storage entity.
*/
export class VirtualizationStorageCapacity extends MoBaseComplexType {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(VirtualizationStorageCapacity.attributeTypeMap);
    }
