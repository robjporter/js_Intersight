...
import { NiatelemetryNiaFeatureUsage } from './NiatelemetryNiaFeatureUsage';
import { NiatelemetryNiaFeatureUsageListAllOf } from './NiatelemetryNiaFeatureUsageListAllOf';
...
*/
export class NiatelemetryNiaFeatureUsageList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<NiatelemetryNiaFeatureUsage>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<NiatelemetryNiaFeatureUsage>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(NiatelemetryNiaFeatureUsageList.attributeTypeMap);
    }
