...
import { HclOperatingSystemListAllOf } from './HclOperatingSystemListAllOf';
...
*/
export class HclOperatingSystemList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<HclOperatingSystem>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<HclOperatingSystem>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(HclOperatingSystemList.attributeTypeMap);
    }
