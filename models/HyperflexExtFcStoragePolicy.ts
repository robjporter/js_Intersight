...
import { HyperflexExtFcStoragePolicyAllOf } from './HyperflexExtFcStoragePolicyAllOf';
import { HyperflexNamedVsan } from './HyperflexNamedVsan';
import { HyperflexWwxnPrefixRange } from './HyperflexWwxnPrefixRange';
...
*/
export class HyperflexExtFcStoragePolicy extends PolicyAbstractPolicy {
    /**
    * Enables or disables external FC storage configuration.
    */
    'adminState'?: boolean;
    'extaTraffic'?: HyperflexNamedVsan;
    'extbTraffic'?: HyperflexNamedVsan;
    'wwxnPrefixRange'?: HyperflexWwxnPrefixRange;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "extaTraffic",
            "baseName": "ExtaTraffic",
            "type": "HyperflexNamedVsan",
            "format": ""
        },
        {
            "name": "extbTraffic",
            "baseName": "ExtbTraffic",
            "type": "HyperflexNamedVsan",
            "format": ""
        },
        {
            "name": "wwxnPrefixRange",
            "baseName": "WwxnPrefixRange",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(HyperflexExtFcStoragePolicy.attributeTypeMap);
    }
