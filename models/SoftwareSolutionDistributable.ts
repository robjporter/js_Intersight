...
import { FirmwareBaseDistributable } from './FirmwareBaseDistributable';
...
import { SoftwareSolutionDistributableAllOf } from './SoftwareSolutionDistributableAllOf';
...
*/
export class SoftwareSolutionDistributable extends FirmwareBaseDistributable {
    /**
    ...
    */
    'subType'?: SoftwareSolutionDistributableSubTypeEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "subType",
            "baseName": "SubType",
            "type": "SoftwareSolutionDistributableSubTypeEnum",
            "format": ""
        },
        {
            "name": "catalog",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(SoftwareSolutionDistributable.attributeTypeMap);
    }
...
export type SoftwareSolutionDistributableSubTypeEnum = "osimage" | "script" ;
