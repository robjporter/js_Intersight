...
export class SnmpTrapAllOf {
    ...
    */
    'version'?: SnmpTrapAllOfVersionEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "version",
            "baseName": "Version",
            "type": "SnmpTrapAllOfVersionEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return SnmpTrapAllOf.attributeTypeMap;
    }
...
export type SnmpTrapAllOfTypeEnum = "Trap" | "Inform" ;
export type SnmpTrapAllOfVersionEnum = "V3" | "V2" ;
