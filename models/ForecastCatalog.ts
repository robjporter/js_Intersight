...
import { ForecastCatalogAllOf } from './ForecastCatalogAllOf';
...
*/
export class ForecastCatalog extends MoBaseMo {
    /**
    ...
    */
    'definition'?: Array<ForecastDefinitionRelationship>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "definition",
            "baseName": "Definition",
            "type": "Array<ForecastDefinitionRelationship>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(ForecastCatalog.attributeTypeMap);
    }
