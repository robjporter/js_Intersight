...
import { InventoryGenericInventoryAllOf } from './InventoryGenericInventoryAllOf';
...
*/
export class InventoryGenericInventory extends InventoryBase {
    'key'?: string;
    'type'?: string;
    'value'?: string;
    'inventoryGenericInventoryHolder'?: InventoryGenericInventoryHolderRelationship;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "inventoryGenericInventoryHolder",
            "baseName": "InventoryGenericInventoryHolder",
            "type": "InventoryGenericInventoryHolderRelationship",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(InventoryGenericInventory.attributeTypeMap);
    }
