...
import { SoftwareHclMeta } from './SoftwareHclMeta';
import { SoftwareHclMetaListAllOf } from './SoftwareHclMetaListAllOf';
...
*/
export class SoftwareHclMetaList extends MoBaseResponse {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<SoftwareHclMeta>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(SoftwareHclMetaList.attributeTypeMap);
    }
