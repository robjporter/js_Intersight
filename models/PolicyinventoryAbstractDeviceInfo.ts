...
import { PolicyinventoryAbstractDeviceInfoAllOf } from './PolicyinventoryAbstractDeviceInfoAllOf';
import { PolicyinventoryJobInfo } from './PolicyinventoryJobInfo';
import { HttpFile } from '../http/http';

/**
* Information pertaining to a Registered Device in Intersight which is pertinent to policy microservice.
*/
export class PolicyinventoryAbstractDeviceInfo extends MoBaseMo {
    /**
    ...
    */
    'errorState'?: string;
    'jobInfo'?: Array<PolicyinventoryJobInfo>;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "jobInfo",
            "baseName": "JobInfo",
            "type": "Array<PolicyinventoryJobInfo>",
            "format": ""
        },
        {
            "name": "operState",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(PolicyinventoryAbstractDeviceInfo.attributeTypeMap);
    }
