...
import { ServerConfigChangeDetailListAllOf } from './ServerConfigChangeDetailListAllOf';
...
*/
export class ServerConfigChangeDetailList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<ServerConfigChangeDetail>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<ServerConfigChangeDetail>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(ServerConfigChangeDetailList.attributeTypeMap);
    }
