...
import { IamResourceLimits } from './IamResourceLimits';
import { IamResourceLimitsListAllOf } from './IamResourceLimitsListAllOf';
...
*/
export class IamResourceLimitsList extends MoBaseResponse {
    /**
    ...
    */
    'results'?: Array<IamResourceLimits>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "results",
            "baseName": "Results",
            "type": "Array<IamResourceLimits>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(IamResourceLimitsList.attributeTypeMap);
    }
