...
export class VnicCdnAllOf {
    ...
    */
    ...
    static getAttributeTypeMap() {
        return VnicCdnAllOf.attributeTypeMap;
    }
...
export type VnicCdnAllOfSourceEnum = "vnic" | "user" ;
