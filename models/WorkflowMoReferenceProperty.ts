...
import { WorkflowMoReferencePropertyAllOf } from './WorkflowMoReferencePropertyAllOf';
import { HttpFile } from '../http/http';

/**
* Capture all the properties for an Intersight managed object reference.
*/
export class WorkflowMoReferenceProperty extends MoBaseComplexType {
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "valueAttribute",
            "baseName": "ValueAttribute",
            "type": "string",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(WorkflowMoReferenceProperty.attributeTypeMap);
    }
